...
INNER JOIN (SELECT * FROM tblBACClarifications d WHERE d.ToUserId=@BuyerId AND d.datePosted=(select max(e.datePosted) FROM tblBACClarifications e WHERE e.BidRefNo=d.BidRefNo)) c ON b.BidRefNo=c.BidRefNo AND c.ToUserId=@BuyerId WHERE b.Status=@Status ORDER BY b.DateSubmitted DESC"
