                                                ...
                                                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                    <tr>
                                                        <td id="content0">
                                                            <h1>
                                                                <br />
                                                                Bid Events for Re-editing</h1>
                                                            <br />
                                                            <asp:GridView runat="server" ID="gvBidsForReediting" SkinID="BidEvents"
                                                                AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" 
                                                                EmptyDataText="No Bid Events To Display."
                                                                DataKeyNames="BidRefNo" DataSourceID="dsBidsForReEditing" OnRowCommand="gvBids_RowCommand">                                                                
                                                                <Columns>
                                                                    <asp:TemplateField HeaderText="Reference No." InsertVisible="False" SortExpression="BidRefNo">
                                                                        <HeaderStyle HorizontalAlign="Center" />  
                                                                        <ItemStyle Width="85px" />
                                                                        <ItemTemplate>
                                                                            &nbsp;<asp:LinkButton ID="lnkBidNo" runat="server" CommandName="BidEvent" CommandArgument='<%# Eval("BidRefNo", "{0}") %>'
                                                                                Text='<%# Bind("BidRefNo") %>'></asp:LinkButton>
                                                                        </ItemTemplate>
                                                                    </asp:TemplateField>
                                                                    <asp:TemplateField HeaderText="Bid Events" SortExpression="ItemDesc">
                                                                        <HeaderStyle HorizontalAlign="Center" />
                                                                        <ItemTemplate>
                                                                            &nbsp;<asp:LinkButton ID="lnkBidEvent" runat="server" CommandName="BidEvent" CommandArgument='<%# Eval("BidRefNo", "{0}") %>'
                                                                    ...
                                                                    <asp:TemplateField HeaderText="Date Submitted" SortExpression="DateSubmitted">
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <asp:Label ID="lblDateSubmitted" runat="server" Text='<%# Eval("DateSubmitted","{0:D}<br />{0:T}") %>'></asp:Label>
                                                                        </ItemTemplate>
                                                                    </asp:TemplateField>
                                                                </Columns>
                                                            </asp:GridView>
                                                            <asp:SqlDataSource ID="dsBidsForReEditing" runat="server" ConnectionString="<%$ ConnectionStrings:EBidConnectionString %>"
                                                                SelectCommand="s3p_EBid_GetForReEditBidEvents" SelectCommandType="StoredProcedure">
                                                                <SelectParameters>
