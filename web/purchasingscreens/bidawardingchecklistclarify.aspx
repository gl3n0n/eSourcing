<%@ Page Language="C#" AutoEventWireup="true" CodeFile="bidawardingchecklistclarify.aspx.cs" Inherits="web_buyerscreens_bidawardingchecklistclarify" EnableViewState="true" MaintainScrollPositionOnPostback="true"  %>
...
<head>
			...
			if (bVendorValueOK == true) {
				for (var i = 0; i < 100; i++) {
					...
					if ($(sCtrl).length == 0) {
					    ...
					    if ($(sCtrl).attr("enabled").toString() == "true") {
	...
	<script type="text/javascript">
		function ShowResponse() {
			...
			if ($("#dialog-message").length == 0) {
				sDiv = "<div id='dialog-message' title='Response: Bid Awarding Checklist' style='display:none; overflow:hidden;'>";
				sDiv = sDiv + "<p>";
				sDiv = sDiv + "<table><tr><td style='font-size:10px;'>Respond to:</td><td style='font-family: Arial; font-size: 11px;'><b>" + $("#RespondTo").val() + "</b>";
			   
				sDiv = sDiv + "    </td>";
				sDiv = sDiv + "</tr><tr><td style='font-family: Arial; font-size: 11px;'>Comment:</td>";
				sDiv = sDiv + "<td><textarea id='txtResponseX' name='txtResponseX' cols='28' rows='5' style='font-family: Arial; font-size: 11; width:200px;'></textarea></td>";
				sDiv = sDiv + "</tr>";
				sDiv = sDiv + "<tr>";
			...
			$("#dialog-message").dialog({
				...
				buttons: {
					Respond: function () {
						$(this).dialog("close");
						if ($("#txtResponseX").val() == '') {
							ShowDialog("Comment  must have a value.", "#txtResponseX");
						}
						else {
							$("#txtResponse").val($("#txtResponseX").val());
							__doPostBack('Respond', '');
						}
					},
					Cancel: function () {
						$(this).dialog("close");
		...
		//	if ($("#dialog-message").length == 0) {
		//		sDiv = "<div id='dialog-message' title='Clarify: Bid Awarding Checklist' style='display:none; overflow:hidden;'>";
		//		sDiv = sDiv + "<p>";
		//		sDiv = sDiv + "<table><tr><td style='font-size:10px;'>Clarify to:</td><td style='font-family: Arial; font-size: 11px;'><b>" + $("#ClarifyTo").val() + "</b>";
		...
		function ShowDraft(myClientID) {
			$("#dialog:ui-dialog").dialog("destroy");

			if ($("#dialog-message").length != 0) $('div').remove("#dialog-message");

			if ($("#dialog-message").length == 0) {
				sDiv = "<div id='dialog-message' title='Bid Awarding Checklist: Save As Draft' style='display:none; overflow:hidden;'>";
				sDiv = sDiv + "<p>";
				sDiv = sDiv + "<table>";
				sDiv = sDiv + "<tr><td style='font-family: Arial; font-size: 11px;'>Comment:</td>";
				sDiv = sDiv + "<td><textarea id='txtDraftX' name='txtDraftX' cols='28' rows='5' style='font-family: Arial; font-size: 11; width:200px;'></textarea></td>";
				sDiv = sDiv + "</tr>";
				sDiv = sDiv + "<tr>";
				sDiv = sDiv + "<td colspan='2' align='right'>";
				sDiv = sDiv + "</td>";
			...
			$("#dialog-message").dialog({
				...
				buttons: {
					Draft: function () {
						$(this).dialog("close");
						if ($("#txtDraftX").val() == '') {
							ShowDialog("Comment  must have a value.", "#txtDraftX");
						}
						else {
							$("#txtDraft").val($("#txtDraftX").val());
							__doPostBack('toDraft', '');
						}
					},
					Cancel: function () {
						$(this).dialog("close");
...
<body id="Body1" runat="server">
	<div>
		...
		<input type="hidden" id="txtResponse" name="txtResponse" runat="server" />
		<input type="hidden" id="RespondTo" name="RespondTo" runat="server" />
		<input type="hidden" id="txtClarify" name="txtClarify" runat="server" />
		<input type="hidden" id="ClarifyTo" name="ClarifyTo" runat="server" />
							...
							<tr>
								...
								<td id="content">
									<table border="0" cellpadding="0" cellspacing="0" width="100%">
										<tr>
											<td valign="top">
												<h1><br />Bid Awarding Checklist for Clarification</h1>
												<script type="text/javascript">
													$(document).ready(function () {
														$('#relatedInfo').hide();
													});
													...
													<tr>
														<td colspan="2" valign="top">
															<table width="50%" border="1" cellpadding="0" cellspacing="0" rules="all" class="itemDetails" id="Biddetails_details1_dvEventDetails" style="border-color:#71A9D2; font-family: Arial; font-size: 11px; border-collapse: collapse; background-color: rgb(219, 234, 245); height:100%">
																<tbody>
																	<tr>
																		<td colspan="4" class="ui-widget-header" style="height:26px; vertical-align:middle;"><asp:Label ID="BACType1" runat="server" Text="BID"></asp:Label> DETAILS</td>
																	</tr>
																	<tr valign="middle" >
																		<td colspan="2" align="center" valign="middle" 
																			style="padding:5px; font-size:12px; " class="style7"><asp:Label ID="BACType2" runat="server" Text="Bid"></asp:Label> Reference No. </td>
																		<td colspan="2" align="center" valign="middle" 
																			style="padding:5px; font-size:12px; " class="style7"><asp:Label ID="BACType3" runat="server" Text="Bid"></asp:Label> Events Description: </td>
																	</tr>
																	<tr valign="middle" >
																		...
																		<td colspan="2" align="center" valign="middle" style="width:25%;">
																			<table width="100%" border="0" cellspacing="0" cellpadding="0">
																				<tr>
																					...
																					<td>
																						<input name="CompanyId"  id="CompanyIdEGG" runat="server" value="3" type="radio" />
																		...
																		<div id="collapseAPR">
																			<asp:Repeater ID="Repeater_SDA_APR" runat="server" DataSourceID="dsSDA_APR" OnItemDataBound="Repeater_SDA_APR_ItemDataBound">
																				...
																				<div style="clear:both">
																					...
																					<a id="lnkSDA_APR" href="bidawardingchecklistclarify.aspx?ShowAttachment=<%# Eval("FileUploadID") %>"
																		...
																		<div id="collapseABC">
																			<asp:Repeater ID="Repeater_SDA_ABC" runat="server" DataSourceID="dsSDA_ABC" OnItemDataBound="Repeater_SDA_ABC_ItemDataBound">
																				...
																				<div style="clear:both">
																					...
																					<a href="bidawardingchecklistclarify.aspx?ShowAttachment=<%# Eval("FileUploadID") %>"
																						target="_blank" title='<%# Eval("ActualFileName") %>'>
																						<%# Eval("OriginalFileName") %></a></div>
																				</ItemTemplate>
																			</asp:Repeater>
																		...
																		<div id="collapseLowestPr">
																			<asp:Repeater ID="Repeater_BFA_LowestPr" runat="server" DataSourceID="dsBFA_LowestPr" OnItemDataBound="Repeater_BFA_LowestPr_ItemDataBound">
																				...
																				<div style="clear:both">
																					...
																					<a id="lnkBFA_LowestPr" href="bidawardingchecklistclarify.aspx?ShowAttachment=<%# Eval("FileUploadID") %>"
																						target="_blank" title='<%# Eval("ActualFileName") %>'><%# Eval("OriginalFileName") %></a></div>
																				</ItemTemplate>
																			</asp:Repeater>
																		</div>
													...
													<tr>
														<td colspan="2" valign="top">
																...
																<tbody>
																	...
																	<tr>
																		...
																		<script type="text/javascript">
																			...
																			<div style="overflow:auto; padding:0px; height:270px;" id="divContainer1">
															...
															<asp:SqlDataSource ID="dsVendors" runat="server" ConnectionString="<%$ ConnectionStrings:EBidConnectionString %>"
																SelectCommand="select CAST(t1.VendorId as char) as VendorId, t1.VendorName from tblVendors t1 where CAST(t1.VendorId as char) NOT IN (select t2.VendorId from tblBACEvaluationSummary t2 where t2.BidRefNo = @BidRefNo) order by t1.VendorName" >
																<SelectParameters>
																	<asp:SessionParameter Name="BidRefNo" SessionField="BuyerBidForBac" Type="Int32" />
																</SelectParameters>
															</asp:SqlDataSource>
...
<HeaderStyle CssClass="ui-widget-header" Font-Size="12px"></HeaderStyle>
																				...
																				<asp:TemplateField HeaderText="PR No" HeaderStyle-CssClass="ui-widget-header" HeaderStyle-Font-Size="12px" HeaderStyle-Width="120px" ItemStyle-HorizontalAlign="Center" ItemStyle-VerticalAlign="Middle">
																					<ItemTemplate>
																						<asp:TextBox ID="lblPRNo" runat="server" Text='<%# Bind("PR_No") %>' Width="200px" Font-Bold="True"></asp:TextBox>
																					</ItemTemplate>
...
<ItemStyle HorizontalAlign="Center" VerticalAlign="Middle"></ItemStyle>
															...
															<asp:SqlDataSource ID="dsItems" runat="server" ConnectionString="<%$ ConnectionStrings:EBidConnectionString %>"
																...
																UNION  select max(BidDetailNo) AS BidDetailNo, '--- Enter New Item ---' AS ItemName, '' PR_No 
																				...
																				<table border="0" cellpadding="0" cellspacing="0"><tbody>
																					<tr>
																						...
																						<asp:SqlDataSource ID="dsBidItemTendersDetails_Vendor" runat="server" ConnectionString="<%$ ConnectionStrings:EBidConnectionString %>"
																							...
																							<SelectParameters>
																								<asp:SessionParameter Name="UserId" SessionField="BuyerBuyerId" Type="Int32" />
																								<asp:SessionParameter Name="BidRefNo" SessionField="BuyerBidForBac" Type="Int32" />
																		...
																		<td width="25%" align="center" valign="middle" style="padding:5px; font-size:12px;">
																			<table width="150" border="0" cellspacing="0" cellpadding="0">
																				<tr>
																					...
																					<asp:Literal ID="lblPurchasingDate" runat="server"></asp:Literal>
																					</td>
																				</tr>
												...
												<table border="0" cellpadding="0" cellspacing="0" width="100%" id="actions">
													<tr>
														<td align="right">
															...
															<input id="btnDraft" type="button" value="Draft" onclick="document.getElementById('status').value=0; GetCriteria(); $('#form1').submit();" />
															...
															<%--<input id="btnEndorse" type="button" value="Clarify" onclick="document.getElementById('status').value=1; ValidateBeforeSave();" />--%>
															<input id="btnDraft" type="button" value="Save" onclick="document.getElementById('status').value = 2; __doPostBack('toDraft', '');" />
															<input id="btnClarify" type="button" value="Clarify" onclick="document.getElementById('status').value = 2; ShowClarify();" />
															<%--<input id="btnEndorse" type="button" value="Respond to clarifier" onclick="document.getElementById('status').value=1; ShowResponse();" />--%>
