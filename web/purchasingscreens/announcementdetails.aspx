<%@ Page Language="c#" EnableEventValidation="true" Inherits="EBid.WEB.purchasing_screens.announcementdetails" CodeFile="announcementdetails.aspx.cs" %>

<%@ Register Src="../usercontrol/announcementdetail.ascx" TagName="announcementdetail"
    TagPrefix="uc3" %>
                    ...
                    <td>
                        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="height: 100%;">
                            <tr>
                                ...
                                <td id="content">
                                    <div align="left">                                        
                                        <uc3:announcementdetail ID="Announcementdetail1" runat="server" />
                                    </div>
                                </td>
                            </tr>
                        </table>
