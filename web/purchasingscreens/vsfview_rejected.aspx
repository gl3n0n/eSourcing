<%@ page language="C#" autoeventwireup="true" inherits="web_buyerscreens_vsfview_rejected, App_Web_vsfview_rejected.aspx.9bdd8cc1" enableviewstate="true" maintainscrollpositiononpostback="true" theme="default" %>
																...
																<tbody>
																	...
																	<tr valign="middle" >
																		...
																		<td width="25%" align="center" valign="middle" style="padding:5px; font-size:12px;">
																			<table width="150" border="0" cellspacing="0" cellpadding="0">
																				<tr>
																					<td colspan="2">Rejected by / date: <br /><asp:Literal ID="lblApprovedDate" runat="server">&nbsp;</asp:Literal></td>
																				</tr><td>&nbsp;</td><tr>
