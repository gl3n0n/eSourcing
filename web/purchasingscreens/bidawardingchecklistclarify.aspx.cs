...
public partial class web_buyerscreens_bidawardingchecklistclarify : System.Web.UI.Page
{
        ...
        if (IsPostBack)
        {
            ...
            else if (control1 == "VendorChange")
            {
                ...
                if (oReader.HasRows)
                {
                    ...
                    sCommand = sCommand + "WHERE BidRefNo=" + Request.Form["BuyerBidForBac"] + " AND VendorID LIKE 'V%'";
            ...
            {
                Session["BuyerBidForBac"] = Request.Form["BuyerBidForBac"];
            ...
            else if (control1 == "Respond")
            {
                CreateCriteriaRow();
                this.Page.ClientScript.RegisterClientScriptBlock(this.GetType(), "SetCriteriaSave", "<script>SetCriteria();</script>");
                doRespond();
            }
            else if (control1 == "toDraft")
            {
                CreateCriteriaRow();
                this.Page.ClientScript.RegisterClientScriptBlock(this.GetType(), "SetCriteriaSave", "<script>SetCriteria();</script>");
                toDraft();
    ...
    void SaveToDB()
    {
        ...
        cAmt = cAmt.Replace(",", "");
        // SAP PR date
        dPRdate = PRDate.Text.ToString() != "" ? DateTime.Parse(PRDate.Text.ToString().Trim()).ToShortDateString() : DateTime.Now.Date.ToString();
        // date received
        dReceived = DateApprovedLbl.Text.ToString() != "" ? DateTime.Parse(DateApprovedLbl.Text.ToString().Trim()).ToShortDateString() : DateTime.Now.Date.ToString();

        sPaymentTerm = ((DropDownList)Form.FindControl("cbPaymentTerms")).SelectedValue.ToString();
        // sourcing strategy
        sCommand = "DELETE FROM tblBACSourcingStrategy WHERE BidRefNo=" + Session["BuyerBidForBac"] + " AND UserId=" + Session["BuyerBuyerId"];
        SqlHelper.ExecuteNonQuery(connstring, CommandType.Text, sCommand);
        foreach (string myCookie in Request.Cookies)
        {
            if (Request.Cookies[myCookie].Name.Contains("myss_"))
            {
                sCommand = "INSERT INTO tblBACSourcingStrategy (BidRefNo, UserId, SourcingStrategy) VALUES(" + Session["BuyerBidForBac"] + ", " + Session["BuyerBuyerId"] + ", '" + Request.Cookies[myCookie].Value.ToString().Replace("'", "") + "')";
                SqlHelper.ExecuteNonQuery(connstring, CommandType.Text, sCommand);
            }
        }
        // type of purchase
        sCommand = "DELETE FROM tblBACTypeOfPurchase WHERE BidRefNo=" + Session["BuyerBidForBac"] + " AND UserId=" + Session["BuyerBuyerId"];
        SqlHelper.ExecuteNonQuery(connstring, CommandType.Text, sCommand);
        foreach (string myCookie in Request.Cookies)
        {
            if (Request.Cookies[myCookie].Name.Contains("mytop_"))
            {
                sCommand = "INSERT INTO tblBACTypeOfPurchase (BidRefNo, UserId, TypeOfPurchase) VALUES(" + Session["BuyerBidForBac"] + ", " + Session["BuyerBuyerId"] + ", '" + Request.Cookies[myCookie].Value.ToString().Replace("'", "") + "')";
                SqlHelper.ExecuteNonQuery(connstring, CommandType.Text, sCommand);
            }
        }
        // payment terms
        sCommand = "DELETE FROM tblBACPaymentTerms WHERE BidRefNo=" + Session["BuyerBidForBac"] + " AND UserId=" + Session["BuyerBuyerId"];
        SqlHelper.ExecuteNonQuery(connstring, CommandType.Text, sCommand);
        foreach (string myCookie in Request.Cookies)
        {
            if (Request.Cookies[myCookie].Name.Contains("mypt_"))
            {
                sCommand = "INSERT INTO tblBACPaymentTerms (BidRefNo, UserId, PaymentTerm) VALUES(" + Session["BuyerBidForBac"] + ", " + Session["BuyerBuyerId"] + ", '" + Request.Cookies[myCookie].Value.ToString().Replace("'", "") + "')";
                SqlHelper.ExecuteNonQuery(connstring, CommandType.Text, sCommand);
            }
        }
        // supply position
        sCommand = "DELETE FROM tblBACSupplyPosition WHERE BidRefNo=" + Session["BuyerBidForBac"] + " AND UserId=" + Session["BuyerBuyerId"];
        SqlHelper.ExecuteNonQuery(connstring, CommandType.Text, sCommand);
        foreach (string myCookie in Request.Cookies)
        {
            if (Request.Cookies[myCookie].Name.Contains("mysp_"))
            {
                sCommand = "INSERT INTO tblBACSupplyPosition (BidRefNo, UserId, SupplyPosition) VALUES(" + Session["BuyerBidForBac"] + ", " + Session["BuyerBuyerId"] + ", '" + Request.Cookies[myCookie].Value.ToString().Replace("'", "") + "')";
                SqlHelper.ExecuteNonQuery(connstring, CommandType.Text, sCommand);
            }
        }
        // basis for awarding
        sCommand = "DELETE FROM tblBACBasisForAwarding WHERE BidRefNo=" + Session["BuyerBidForBac"] + " AND UserId=" + Session["BuyerBuyerId"];
        SqlHelper.ExecuteNonQuery(connstring, CommandType.Text, sCommand);
        foreach (string myCookie in Request.Cookies)
        {
            if (Request.Cookies[myCookie].Name.Contains("mybfa_"))
            {
                sCommand = "INSERT INTO tblBACBasisForAwarding (BidRefNo, UserId, BasisForAwarding) VALUES(" + Session["BuyerBidForBac"] + ", " + Session["BuyerBuyerId"] + ", '" + Request.Cookies[myCookie].Value.ToString().Replace("'", "") + "')";
                SqlHelper.ExecuteNonQuery(connstring, CommandType.Text, sCommand);
            }
        }
        // nature of savings
        sCommand = "DELETE FROM tblBACNatureOfSavings WHERE BidRefNo=" + Session["BuyerBidForBac"] + " AND UserId=" + Session["BuyerBuyerId"];
        SqlHelper.ExecuteNonQuery(connstring, CommandType.Text, sCommand);
        foreach (string myCookie in Request.Cookies)
        {
            if (Request.Cookies[myCookie].Name.Contains("mynos_"))
            {
                sCommand = "INSERT INTO tblBACNatureOfSavings (BidRefNo, UserId, NatureOfSavings) VALUES(" + Session["BuyerBidForBac"] + ", " + Session["BuyerBuyerId"] + ", '" + Request.Cookies[myCookie].Value.ToString().Replace("'", "") + "')";
                SqlHelper.ExecuteNonQuery(connstring, CommandType.Text, sCommand);
            }
        }
        ...
        sCommand = sCommand + "BidRefNo = " + Session["BuyerBidForBac"] + ", Budgeted=" + Request.Form["Budgeted"] + ", CompanyID=" + Request.Form["CompanyId"] + ", ItemDesc='" + sItemDesc.Replace("'", "''") + "', BuyerID=" + Session["BuyerBuyerId"] + ", SAPPRNo='" + iSAP + "', BidAmount=" + cAmt + ", SAPPRDate='" + dPRdate + "', RcvdDate= '" + dReceived + "', ";
        sCommand = sCommand + " SS_NoBidders=" + ss_nobidders + ", SS_NoBidsRcvd=" + ss_nobidsrcvd + ", SS_TechCompliance=" + ss_techcompliance + ", Status=" + status1 + ",  SavingsGen_Amount=" + Request.Form["lblNegDisc"].Replace(",", "") + ", SavingsGen_PctSpend=" + Request.Form["lblPercentSpend"].Replace(",", "") + ", descPaymentTerms='" + Request.Form["descPaymentTerms"].ToString().Replace("'", "''") + "', ss_crc_no='" + Request.Form["ss_crcnumber"].Replace("'", "''") + "', LowestPriceBidder=" + chkLowestPriceBidder + ", BidRefNoParent = " + Request.Form["BuyerBidForBacParent"] + "  WHERE BidRefNo =" + Session["BuyerBidForBac"];
        //LogHelper.TextLogHelper.Log(Server.MapPath("ebid.log"), sCommand);
        SqlHelper.ExecuteNonQuery(connstring, CommandType.Text, sCommand);

        // add row to tblBACExecutiveSummary table
        sCommand = "DELETE tblBACExecutiveSummary WHERE BidRefNo=" + Session["BuyerBidForBac"] + " AND UserID=" + Session["BuyerBuyerId"];
        SqlHelper.ExecuteNonQuery(connstring, CommandType.Text, sCommand);

        sCommand = "INSERT INTO tblBACExecutiveSummary (BidRefNo, UserID, Comment) VALUES (";
        sCommand = sCommand + Session["BuyerBidForBac"] + ", " + Session["BuyerBuyerId"] + ", '" + (Request.Form["executive_summary"].Replace("\n", "<br />")).Replace("'", "''") + "')";
        SqlHelper.ExecuteNonQuery(connstring, CommandType.Text, sCommand);
        ...
        string xPurchasingID = "";
        sCommand = "SELECT t1.PurchasingID, t2.LastName + ', ' + t2.FirstName + ' ' + t2.MiddleName AS Name1 FROM tblSupervisor t1  INNER JOIN tblPurchasing t2 ON t1.PurchasingID=t2.PurchasingID WHERE BuyerID=" + Session["BuyerBuyerId"];
        oReader = SqlHelper.ExecuteReader(connstring, CommandType.Text, sCommand);
        if (oReader.HasRows)
        {
            oReader.Read();
            xPurchasingID = oReader["PurchasingID"].ToString();
        }
        oReader.Close();

        //clear all;
        //if (xPurchasingID == Session["ClarifiedBy"].ToString())
        //{
            sCommand = "UPDATE tblBacBidItems SET Approver_1=NULL, Approver_2=NULL, Approver_3=NULL, Approver_4=NULL, Approver_5=NULL, Approver_6=NULL, Approver_7=NULL, Approver_8=NULL, Approver_9=NULL, Approver_10=NULL WHERE BidRefNo=" + Session["BuyerBidForBac"];
            //LogHelper.TextLogHelper.Log(Server.MapPath("ebid.log"), sCommand);
            SqlHelper.ExecuteNonQuery(connstring, CommandType.Text, sCommand);
        //}
        ...
        foreach (RepeaterItem rpItem in RepeaterApprover.Items)
        {
            ...
            sCommand = "UPDATE tblBacBidItems SET Approver_" + chkApproverLevelCount.ToString() + "=null WHERE BidRefNo=" + Session["BuyerBidForBac"] + " AND BuyerId=" + Session["BuyerBuyerId"];
            //LogHelper.TextLogHelper.Log(Server.MapPath("ebid.log"), sCommand);
            //SqlHelper.ExecuteNonQuery(connstring, CommandType.Text, sCommand);
            if (chkbx.Checked == true)
            {
                chkApproverLevelCount++;
                sCommand = "UPDATE tblBacBidItems SET Approver_" + chkApproverLevelCount.ToString() + "=" + Convert.ToInt32(chkbx.Attributes["value"].ToString()) + " WHERE BidRefNo=" + Session["BuyerBidForBac"] + " AND BuyerId=" + Session["BuyerBuyerId"];
                SqlHelper.ExecuteNonQuery(connstring, CommandType.Text, sCommand);
                //Response.Write(sCommand);
            }
        }
        ...
        {
            //sCommand = "UPDATE tblBacBidItems SET DateSubmitted=getdate() WHERE BidRefNo=" + Session["BuyerBidForBac"];
            //SqlHelper.ExecuteNonQuery(connstring, CommandType.Text, sCommand);
    ...
    protected void doClarify()
    {
        ...
        if (InsertClarification() == 2)
        {
            ...
            //sCommand = "INSERT INTO tblBACClarifications (BidRefNo, FrUserId, Comment, ToUserId, DatePosted, Status) VALUES (";
            //sCommand = sCommand + Session["BuyerBidForBac"].ToString() + ", " + Session["UserId"] + ", '" + Request.Form["txtClarify"].ToString().Replace("'", "''") + "', " + Request.Form["__EVENTARGUMENT"].ToString().Trim() + ", GETDATE(), 0)";
            ////SqlHelper.ExecuteNonQuery(connstring, CommandType.Text, sCommand);
    ...
    protected void doRespond()
    {
        ...
        //string[] Arr = NextApprover().Split(';');
        ////Response.Write(Arr[2].ToString());

        //// add row to tblBACComments table
        //sCommand = "INSERT INTO tblBACComments (BidRefNo, UserId, Comment, DatePosted) VALUES (";
        //sCommand = sCommand + Session["BuyerBidForBac"].ToString() + ", " + Session["UserId"] + ", '" + Request.Form["txtResponse"].Replace("'", "''").Replace("\n", "<br />") + "', GETDATE())";
        //SqlHelper.ExecuteNonQuery(connstring, CommandType.Text, sCommand);
    ...
    protected void toDraft()
    {
        ...
        // Clear Approved and Clarfied from tblBacBidItems table
        sCommand = "UPDATE tblBacBidItems SET ClarifyDt_0=NULL, ClarifyDt_1=NULL, ClarifyDt_2=NULL, ClarifyDt_3=NULL, ClarifyDt_4=NULL, ClarifyDt_5=NULL, ClarifyDt_6=NULL, ClarifyDt_7=NULL, ClarifyDt_8=NULL, ClarifyDt_9=NULL, ClarifyDt_10=NULL, ApprovedDt_0=NULL, ApprovedDt_1=NULL, ApprovedDt_2=NULL, ApprovedDt_3=NULL, ApprovedDt_4=NULL, ApprovedDt_5=NULL, ApprovedDt_6=NULL, ApprovedDt_7=NULL, ApprovedDt_8=NULL, ApprovedDt_9=NULL, ApprovedDt_10=NULL, Status = 0  WHERE BacRefNo=" + Session["BuyerBacRefNo"];
        //SqlHelper.ExecuteNonQuery(connstring, CommandType.Text, sCommand);
    ...
    void UpdateDB()
    {
        ...
        if (IsNumber(Request.Form["ss_techcompliance"]) == true) ss_techcompliance = Request.Form["ss_techcompliance"];
        string lblNegDisc = "0";
        if (IsNumber(Request.Form["lblNegDisc"]) == true) lblNegDisc = Request.Form["lblNegDisc"].Replace(",", "").Replace("%", "");
        string lblPercentSpend = "0";
        if (IsNumber(Request.Form["lblPercentSpend"]) == true) lblPercentSpend = Request.Form["lblPercentSpend"].Replace(",", "").Replace("%", "");
        int chkLowestPriceBidder = 0;
        if (LowestPriceBidder.Checked) chkLowestPriceBidder = 1;


        sCommand = "UPDATE tblBacBidItems SET ";
        sCommand = sCommand + "BidRefNo = " + Session["BuyerBidForBac"] + ", Budgeted=" + Request.Form["Budgeted"] + ", CompanyID=" + Request.Form["CompanyId"] + ", ItemDesc='" + sItemDesc.Replace("'", "''") + "', BuyerID=" + Session["BuyerBuyerId"] + ", SAPPRNo='" + iSAP + "', BidAmount=" + cAmt + ", SAPPRDate='" + DateTime.Parse(Request.Form["PRDate"].ToString().Trim()).ToShortDateString() + "', RcvdDate= '" + DateTime.Parse(Request.Form["DateApprovedLbl"].ToString().Trim()).ToShortDateString() + "', ";
        sCommand = sCommand + " SS_NoBidders=" + ss_nobidders + ", SS_NoBidsRcvd=" + ss_nobidsrcvd + ", SS_TechCompliance=" + ss_techcompliance + ", Status=" + status1 + ",  SavingsGen_Amount=" + lblNegDisc + ", SavingsGen_PctSpend=" + lblPercentSpend + ", descPaymentTerms='" + Request.Form["descPaymentTerms"].Replace("'", "''") + "', ss_crc_no='" + Request.Form["ss_crcnumber"].Replace("'", "''") + "', LowestPriceBidder=" + chkLowestPriceBidder + ", BidRefNoParent = " + Request.Form["BuyerBidForBacParent"] + "  WHERE BidRefNo =" + Session["BuyerBidForBac"];
        SqlHelper.ExecuteNonQuery(connstring, CommandType.Text, sCommand);

        // sourcing strategy
        sCommand = "DELETE FROM tblBACSourcingStrategy WHERE BidRefNo=" + Request.Form["BuyerBidForBac"] + " AND UserId=" + Session["BuyerBuyerId"];
        SqlHelper.ExecuteNonQuery(connstring, CommandType.Text, sCommand);
        foreach (string myCookie in Request.Cookies)
        {
            if (Request.Cookies[myCookie].Name.Contains("myss_"))
            {
                sCommand = "INSERT INTO tblBACSourcingStrategy (BidRefNo, UserId, SourcingStrategy) VALUES(" + Request.Form["BuyerBidForBac"] + ", " + Session["BuyerBuyerId"] + ", '" + Request.Cookies[myCookie].Value.ToString().Replace("'", "") + "')";
                SqlHelper.ExecuteNonQuery(connstring, CommandType.Text, sCommand);
            }
        }
        // type of purchase
        sCommand = "DELETE FROM tblBACTypeOfPurchase WHERE BidRefNo=" + Request.Form["BuyerBidForBac"] + " AND UserId=" + Session["BuyerBuyerId"];
        SqlHelper.ExecuteNonQuery(connstring, CommandType.Text, sCommand);
        foreach (string myCookie in Request.Cookies)
        {
            if (Request.Cookies[myCookie].Name.Contains("mytop_"))
            {
                sCommand = "INSERT INTO tblBACTypeOfPurchase (BidRefNo, UserId, TypeOfPurchase) VALUES(" + Request.Form["BuyerBidForBac"] + ", " + Session["BuyerBuyerId"] + ", '" + Request.Cookies[myCookie].Value.ToString().Replace("'", "") + "')";
                SqlHelper.ExecuteNonQuery(connstring, CommandType.Text, sCommand);
            }
        }
        // payment terms
        sCommand = "DELETE FROM tblBACPaymentTerms WHERE BidRefNo=" + Request.Form["BuyerBidForBac"] + " AND UserId=" + Session["UserId"];
        SqlHelper.ExecuteNonQuery(connstring, CommandType.Text, sCommand);
        foreach (string myCookie in Request.Cookies)
        {
            if (Request.Cookies[myCookie].Name.Contains("mypt_"))
            {
                sCommand = "INSERT INTO tblBACPaymentTerms (BidRefNo, UserId, PaymentTerm) VALUES(" + Request.Form["BuyerBidForBac"] + ", " + Session["BuyerBuyerId"] + ", '" + Request.Cookies[myCookie].Value.ToString().Replace("'", "") + "')";
                SqlHelper.ExecuteNonQuery(connstring, CommandType.Text, sCommand);
            }
        }
        // supply position
        sCommand = "DELETE FROM tblBACSupplyPosition WHERE BidRefNo=" + Request.Form["BuyerBidForBac"] + " AND UserId=" + Session["BuyerBuyerId"];
        SqlHelper.ExecuteNonQuery(connstring, CommandType.Text, sCommand);
        foreach (string myCookie in Request.Cookies)
        {
            if (Request.Cookies[myCookie].Name.Contains("mysp_"))
            {
                sCommand = "INSERT INTO tblBACSupplyPosition (BidRefNo, UserId, SupplyPosition) VALUES(" + Request.Form["BuyerBidForBac"] + ", " + Session["BuyerBuyerId"] + ", '" + Request.Cookies[myCookie].Value.ToString().Replace("'", "") + "')";
                SqlHelper.ExecuteNonQuery(connstring, CommandType.Text, sCommand);
            }
        }
        // basis for awarding
        sCommand = "DELETE FROM tblBACBasisForAwarding WHERE BidRefNo=" + Request.Form["BuyerBidForBac"] + " AND UserId=" + Session["BuyerBuyerId"];
        SqlHelper.ExecuteNonQuery(connstring, CommandType.Text, sCommand);
        foreach (string myCookie in Request.Cookies)
        {
            if (Request.Cookies[myCookie].Name.Contains("mybfa_"))
            {
                sCommand = "INSERT INTO tblBACBasisForAwarding (BidRefNo, UserId, BasisForAwarding) VALUES(" + Request.Form["BuyerBidForBac"] + ", " + Session["BuyerBuyerId"] + ", '" + Request.Cookies[myCookie].Value.ToString().Replace("'", "") + "')";
                SqlHelper.ExecuteNonQuery(connstring, CommandType.Text, sCommand);
            }
        }
        // nature of savings
        sCommand = "DELETE FROM tblBACNatureOfSavings WHERE BidRefNo=" + Request.Form["BuyerBidForBac"] + " AND UserId=" + Session["BuyerBuyerId"];
        SqlHelper.ExecuteNonQuery(connstring, CommandType.Text, sCommand);
        foreach (string myCookie in Request.Cookies)
        {
            if (Request.Cookies[myCookie].Name.Contains("mynos_"))
            {
                sCommand = "INSERT INTO tblBACNatureOfSavings (BidRefNo, UserId, NatureOfSavings) VALUES(" + Request.Form["BuyerBidForBac"] + ", " + Session["BuyerBuyerId"] + ", '" + Request.Cookies[myCookie].Value.ToString().Replace("'", "") + "')";
                SqlHelper.ExecuteNonQuery(connstring, CommandType.Text, sCommand);
            }
        }
    }
        ...
        if (fileUpload.HasFile)
        {
            ...
            if (!FileUploadHelper.IsFileForbidden(fInfo.Extension))
            {
                ...
                if (fileSize < maxFileSize)
                {
                    ...
                    string actual = FileUploadHelper.GetNewAlternativeFileName(Session["BuyerBuyerId"].ToString(), fInfo.Extension);
                    try
                    {
                        sCommand = "SELECT * FROM tblBACSupportingDocuments WHERE BidRefNo=" + Session["BuyerBidForBac"] + " AND BuyerID=" + Session["BuyerBuyerId"] + " AND DocuName='" + Request.Form["SupportDocuAttached"] + "' AND OriginalFileName='" + original + "'";
                        oReader = SqlHelper.ExecuteReader(connstring, CommandType.Text, sCommand);
                        if (oReader.HasRows)
                        {
                            oReader.Read();
                            sCommand = (string)oReader["ActualFileName"];
                            delFile = new FileInfo(Constant.FILEATTACHMENTSFOLDERDIR + Session["BuyerBuyerId"] + "\\BAC\\" + sCommand + ".gz");
                            if (delFile.Exists)
                            {
                                File.Delete(Constant.FILEATTACHMENTSFOLDERDIR + Session["BuyerBuyerId"] + "\\BAC\\" + sCommand + ".gz");
                            }
                        }

                        oDir = new DirectoryInfo(Constant.FILEATTACHMENTSFOLDERDIR + Session["BuyerBuyerId"]);
                        if (oDir.Exists == false) oDir.Create();
                        oDir = new DirectoryInfo(Constant.FILEATTACHMENTSFOLDERDIR + Session["BuyerBuyerId"] + "\\BAC");
                        if (oDir.Exists == false) oDir.Create();
                        fileUpload.SaveAs((Constant.FILEATTACHMENTSFOLDERDIR) + Session["BuyerBuyerId"] + "\\BAC\\" + actual);
                        delFile = new FileInfo((Constant.FILEATTACHMENTSFOLDERDIR) + Session["BuyerBuyerId"] + "\\BAC\\" + actual);
                        CompressFile(delFile);
                        delFile.Delete();

                        // update table
                        sCommand = "DELETE FROM tblBACSupportingDocuments WHERE BidRefNo=" + Session["BuyerBidForBac"] + " ";
                        sCommand = sCommand + "AND BuyerID=" + Session["BuyerBuyerId"] + " AND OriginalFileName='" + original + "' AND DocuName='" + Request.Form["SupportDocuAttached"] + "'";
                        ...
                        sCommand1 = sCommand1 + Session["BuyerBidForBac"] + ", " + Session["BuyerBuyerId"] + ", '" + Request.Form["SupportDocuAttached"] + "', '";
    ...
    void AttachMyFile2()
    {
        ...
        if (fileUpload2.HasFile)
        {
            ...
            if (!FileUploadHelper.IsFileForbidden(fInfo.Extension))
            {
                ...
                if (fileSize < maxFileSize)
                {
                    string original = fileUpload2.FileName.ToString().Trim();
                    string actual = FileUploadHelper.GetNewAlternativeFileName(Session["BuyerBuyerId"].ToString(), fInfo.Extension);
                    try
                    {
                        sCommand = "SELECT * FROM tblBACSupportingDocuments WHERE BidRefNo=" + Session["BuyerBidForBac"] + " AND BuyerID=" + Session["BuyerBuyerId"] + " AND DocuName='" + Request.Form["BasisForAwardingAttchd"] + "' AND OriginalFileName='" + original + "'";
                        oReader = SqlHelper.ExecuteReader(connstring, CommandType.Text, sCommand);
                        if (oReader.HasRows)
                        {
                            oReader.Read();
                        ...
                        oDir = new DirectoryInfo(Constant.FILEATTACHMENTSFOLDERDIR + Session["BuyerBuyerId"] + "\\BAC");
                        if (oDir.Exists == false) oDir.Create();
                        fileUpload2.SaveAs((Constant.FILEATTACHMENTSFOLDERDIR) + Session["BuyerBuyerId"] + "\\BAC\\" + actual);
                        delFile = new FileInfo((Constant.FILEATTACHMENTSFOLDERDIR) + Session["BuyerBuyerId"] + "\\BAC\\" + actual);
                        CompressFile(delFile);
                        delFile.Delete();
                        ...
                        // update table
                        sCommand = "DELETE FROM tblBACSupportingDocuments WHERE BidRefNo=" + Session["BuyerBidForBac"] + " ";
                        sCommand = sCommand + "AND BuyerID=" + Session["BuyerBuyerId"] + " AND OriginalFileName='" + original + "' AND DocuName='" + Request.Form["BasisForAwardingAttchd"] + "'";

                        sCommand1 = "INSERT INTO tblBACSupportingDocuments (BidRefNo, BuyerID, DocuName, OriginalFileName, ActualFileName, ContentType, DateUploaded, IsDetachable) VALUES (";
                        sCommand1 = sCommand1 + Session["BuyerBidForBac"] + ", " + Session["BuyerBuyerId"] + ", '" + Request.Form["BasisForAwardingAttchd"] + "', '";
                        sCommand1 = sCommand1 + original + "', '" + actual + "', '" + sContentType + "', GETDATE(), 1)";
                        //Response.Write(sCommand1);
    ...
    protected void count_attachements()
    {
        ...
        //Approved_PR
        sCommand = "SELECT Count(*) as Count FROM tblBACSupportingDocuments WHERE BuyerID=" + Session["BuyerBuyerId"] + " AND BidRefNo=" + Session["BuyerBidForBac"] + " AND DocuName='Approved_PR'";
        oReader = SqlHelper.ExecuteReader(connstring, CommandType.Text, sCommand);
        if (oReader.HasRows)
        {
            oReader.Read();
        ...
        sCommand = "SELECT Count(*) as Count FROM tblBACSupportingDocuments WHERE BuyerID=" + Session["BuyerBuyerId"] + " AND BidRefNo=" + Session["BuyerBidForBac"] + " AND DocuName='Commercial_Evaluation'";
        oReader = SqlHelper.ExecuteReader(connstring, CommandType.Text, sCommand);
        if (oReader.HasRows)
        {
            oReader.Read();
        ...
        sCommand = "SELECT Count(*) as Count FROM tblBACSupportingDocuments WHERE BuyerID=" + Session["BuyerBuyerId"] + " AND BidRefNo=" + Session["BuyerBidForBac"] + " AND DocuName='Approved_Business_Case'";
        oReader = SqlHelper.ExecuteReader(connstring, CommandType.Text, sCommand);
        if (oReader.HasRows)
        {
            oReader.Read();
        ...
        //Board_Resolution
        sCommand = "SELECT Count(*) as Count FROM tblBACSupportingDocuments WHERE BuyerID=" + Session["BuyerBuyerId"] + " AND BidRefNo=" + Session["BuyerBidForBac"] + " AND DocuName='Board_Resolution'";
        oReader = SqlHelper.ExecuteReader(connstring, CommandType.Text, sCommand);
        if (oReader.HasRows)
        {
            oReader.Read();
        ...
        sCommand = "SELECT Count(*) as Count FROM tblBACSupportingDocuments WHERE BuyerID=" + Session["BuyerBuyerId"] + " AND BidRefNo=" + Session["BuyerBidForBac"] + " AND DocuName='Technical_Evaluation'";
        oReader = SqlHelper.ExecuteReader(connstring, CommandType.Text, sCommand);
        if (oReader.HasRows)
        {
            oReader.Read();
        ...
        //Negotiation_Results
        sCommand = "SELECT Count(*) as Count FROM tblBACSupportingDocuments WHERE BuyerID=" + Session["BuyerBuyerId"] + " AND BidRefNo=" + Session["BuyerBidForBac"] + " AND DocuName='Negotiation_Results'";
        oReader = SqlHelper.ExecuteReader(connstring, CommandType.Text, sCommand);
        if (oReader.HasRows)
        {
            oReader.Read();
        ...
        //Others
        sCommand = "SELECT Count(*) as Count FROM tblBACSupportingDocuments WHERE BuyerID=" + Session["BuyerBuyerId"] + " AND BidRefNo=" + Session["BuyerBidForBac"] + " AND DocuName='Others'";
        oReader = SqlHelper.ExecuteReader(connstring, CommandType.Text, sCommand);
        if (oReader.HasRows)
        {
            oReader.Read();
        ...
        //BASIS FOR AWARDING
        //bfa_LowestPr
        sCommand = "SELECT Count(*) as Count FROM tblBACSupportingDocuments WHERE BuyerID=" + Session["BuyerBuyerId"] + " AND BidRefNo=" + Session["BuyerBidForBac"] + " AND DocuName='bfa_LowestPr'";
        oReader = SqlHelper.ExecuteReader(connstring, CommandType.Text, sCommand);
        if (oReader.HasRows)
        {
            oReader.Read();
        ...
        //bfa_SoleLOA
        sCommand = "SELECT Count(*) as Count FROM tblBACSupportingDocuments WHERE BuyerID=" + Session["BuyerBuyerId"] + " AND BidRefNo=" + Session["BuyerBidForBac"] + " AND DocuName='bfa_SoleLOA'";
        oReader = SqlHelper.ExecuteReader(connstring, CommandType.Text, sCommand);
        if (oReader.HasRows)
        {
            oReader.Read();
        ...
        //bfa_SoleCSD
        sCommand = "SELECT Count(*) as Count FROM tblBACSupportingDocuments WHERE BuyerID=" + Session["BuyerBuyerId"] + " AND BidRefNo=" + Session["BuyerBidForBac"] + " AND DocuName='bfa_SoleCSD'";
        oReader = SqlHelper.ExecuteReader(connstring, CommandType.Text, sCommand);
        if (oReader.HasRows)
        {
            oReader.Read();
        ...
        //bfa_TechSpec
        sCommand = "SELECT Count(*) as Count FROM tblBACSupportingDocuments WHERE BuyerID=" + Session["BuyerBuyerId"] + " AND BidRefNo=" + Session["BuyerBidForBac"] + " AND DocuName='bfa_TechSpec'";
        oReader = SqlHelper.ExecuteReader(connstring, CommandType.Text, sCommand);
        if (oReader.HasRows)
        {
            oReader.Read();
        ...
        //bfa_LeadTime
        sCommand = "SELECT Count(*) as Count FROM tblBACSupportingDocuments WHERE BuyerID=" + Session["BuyerBuyerId"] + " AND BidRefNo=" + Session["BuyerBidForBac"] + " AND DocuName='bfa_LeadTime'";
        oReader = SqlHelper.ExecuteReader(connstring, CommandType.Text, sCommand);
        if (oReader.HasRows)
        {
            oReader.Read();
        ...
        //bfa_BFAOth
        sCommand = "SELECT Count(*) as Count FROM tblBACSupportingDocuments WHERE BuyerID=" + Session["BuyerBuyerId"] + " AND BidRefNo=" + Session["BuyerBidForBac"] + " AND DocuName='bfa_BFAOth'";
        oReader = SqlHelper.ExecuteReader(connstring, CommandType.Text, sCommand);
        if (oReader.HasRows)
        {
            oReader.Read();
    ...
    protected void doBuyerBidForBac()
    {
        ...
        // sourcing strategy
        i = 0;
        sCommand = "SELECT * FROM tblBACSourcingStrategy WHERE BidRefNo=" + Session["BuyerBidForBac"].ToString() + " AND UserId=" + Session["BuyerBuyerId"];
        oReader = SqlHelper.ExecuteReader(connstring, CommandType.Text, sCommand);
        if (oReader.HasRows)
        {
            while (oReader.Read())
        ...
        // type of purchase
        i = 0;
        sCommand = "SELECT * FROM tblBACTypeOfPurchase WHERE BidRefNo=" + Session["BuyerBidForBac"].ToString() + " AND UserId=" + Session["BuyerBuyerId"];
        oReader = SqlHelper.ExecuteReader(connstring, CommandType.Text, sCommand);
        if (oReader.HasRows)
        {
            while (oReader.Read())
        ...
        // supply position
        i = 0;
        sCommand = "SELECT * FROM tblBACSupplyPosition WHERE BidRefNo=" + Session["BuyerBidForBac"].ToString() + " AND UserId=" + Session["BuyerBuyerId"];
        oReader = SqlHelper.ExecuteReader(connstring, CommandType.Text, sCommand);
        if (oReader.HasRows)
        {
            while (oReader.Read())
        ...
        // basis for awarding
        i = 0;
        sCommand = "SELECT * FROM tblBACBasisForAwarding WHERE BidRefNo=" + Session["BuyerBidForBac"].ToString() + " AND UserId=" + Session["BuyerBuyerId"];
        oReader = SqlHelper.ExecuteReader(connstring, CommandType.Text, sCommand);
        if (oReader.HasRows)
        {
            while (oReader.Read())
        ...
        // nature of savings
        i = 0;
        sCommand = "SELECT * FROM tblBACNatureOfSavings WHERE BidRefNo=" + Session["BuyerBidForBac"].ToString() + " AND UserId=" + Session["BuyerBuyerId"];
        oReader = SqlHelper.ExecuteReader(connstring, CommandType.Text, sCommand);
        if (oReader.HasRows)
        {
            while (oReader.Read())
            {
                i++;
                ClientScript.RegisterStartupScript(this.GetType(), "nos_" + i, "<script language='Javascript'>AddTRCheckBoxFromDB('#myNatureOfSavings', 'nos', '" + oReader["NatureOfSavings"].ToString() + "');</script>");
            }
        }
        oReader.Close();
        ...
        // payment terms
        i = 0;
        sCommand = "SELECT * FROM tblBACPaymentTerms WHERE BidRefNo=" + Session["BuyerBidForBac"].ToString() + " AND UserId=" + Session["BuyerBuyerId"];
        oReader = SqlHelper.ExecuteReader(connstring, CommandType.Text, sCommand);
        if (oReader.HasRows)
        {
            while (oReader.Read())
        ...
        // executive summary
        sCommand = "SELECT * FROM tblBACExecutiveSummary WHERE BidRefNo=" + Session["BuyerBidForBac"].ToString() + " AND UserId=" + Session["BuyerBuyerId"];
        oReader = SqlHelper.ExecuteReader(connstring, CommandType.Text, sCommand);
        if (oReader.HasRows)
        {
            oReader.Read();
        ...
        sCommand = "SELECT Comment FROM tblBACComments WHERE BidRefNo=" + Session["BuyerBidForBac"].ToString() + " AND UserId=" + Session["BuyerBuyerId"];
        oReader = SqlHelper.ExecuteReader(connstring, CommandType.Text, sCommand);
        if (oReader.HasRows)
        {
            while (oReader.Read())
    ...
    protected void UpdateCommercialDetails()
    {
        ...
        foreach (GridViewRow oGrid in gvItems.Rows)
        {
            ...
            LinkButton oTxt2 = ((LinkButton)oGrid.FindControl("lblAddItem"));
            sCommand = "UPDATE tblBACEvaluationDetails SET PR_No='" + oPRNo.Text.Replace("'", "").Replace("'", "''").Trim() + "' , ItemName='" + oItemD.Text.Replace("'", "") + "' WHERE BidRefNo=" + Session["BuyerBidForBac"] + " ";
            sCommand = sCommand + "AND BidDetailNo=" + oTxt2.CommandArgument.ToString() + " AND UserId=" + Session["BuyerBuyerId"];
        ...
        foreach (DataListItem oItem in lstCommDetails.Items)
        {
            ...
            foreach (RepeaterItem oRptItem in oRpt.Items)
            {
                if (oRptItem.ItemType == ListItemType.Item || oRptItem.ItemType == ListItemType.AlternatingItem)
                {
                    ...
                    sCommand = "UPDATE tblBACEvaluationDetails SET VendorName='" + oTxt2.Text.Replace("'", "''").Trim() + "' WHERE BidRefNo=" + Session["BuyerBidForBac"] + " ";
                    sCommand = sCommand + "AND BidDetailNo=" + sBidDetailNo1 + " AND BidTenderNo='" + sBidTender1 + "' AND UserId=" + Session["BuyerBuyerId"];
                    //SqlHelper.ExecuteNonQuery(connstring, CommandType.Text, sCommand);
                }
            }
            // quantity
            ...
            foreach (RepeaterItem oRptItem in oRpt.Items)
            {
                if (oRptItem.ItemType == ListItemType.Item || oRptItem.ItemType == ListItemType.AlternatingItem)
                {
                    ...
                    sCommand = sCommand + "AND BidDetailNo=" + sBidDetailNo1 + " AND BidTenderNo='" + sBidTender1 + "' AND UserId=" + Session["BuyerBuyerId"] + " AND VendorName = '" + txtVendorName2.Trim().Replace("'", "''") + "'";
                    SqlHelper.ExecuteNonQuery(connstring, CommandType.Text, sCommand);
                }
            }
            // unit of measure
            ...
            foreach (RepeaterItem oRptItem in oRpt.Items)
            {
                if (oRptItem.ItemType == ListItemType.Item || oRptItem.ItemType == ListItemType.AlternatingItem)
                {
                    ...
                    sCommand = "UPDATE tblBACEvaluationDetails SET UnitMeasure='" + oTxt.Text.Replace("'", "''").Trim() + "' WHERE BidRefNo=" + Session["BuyerBidForBac"] + " ";
                    sCommand = sCommand + "AND BidDetailNo=" + sBidDetailNo1 + " AND BidTenderNo='" + sBidTender1 + "' AND UserId=" + Session["BuyerBuyerId"] + " AND VendorName = '" + txtVendorName2.Trim().Replace("'", "''") + "'";
                    SqlHelper.ExecuteNonQuery(connstring, CommandType.Text, sCommand);
                }
            }
            ...
            sCommand = sCommand + "AND Chkd=1 AND UserId=" + Session["BuyerBuyerId"] + "),0) Where BidRefNo=" + Session["BuyerBidForBac"];
            SqlHelper.ExecuteNonQuery(connstring, CommandType.Text, sCommand);
    ...
    private string NextApprover()
    {
        ...
        string sCommand;
        SqlDataReader oReader;
        string sNextApprover = "";

        string query; SqlCommand cmd; SqlConnection conn; query = "Select * From vwBacBidApprovers WHERE";
        sCommand = "SELECT TOP 1 * FROM (SELECT " + Session["BuyerBidForBac"] + " as BidRefNo, t1.PurchasingID BACId, t2.LastName + ', ' + t2.FirstName + ' ' + t2.MiddleName AS Name1, (SELECT ApprovedDt_0 FROM tblBacBidItems WHERE BidRefNo = " + Session["BuyerBidForBac"] + ") as ApprovedDt, 0 ApprovingLimit FROM tblSupervisor t1 INNER JOIN tblPurchasing t2 ON t1.PurchasingID=t2.PurchasingID WHERE BuyerID=" + Session["BuyerBuyerId"];
        sCommand = sCommand + " UNION ";
        sCommand = sCommand + "Select * From vwBacBidApprovers WHERE BidRefNo=" + Session["BuyerBidForBac"];
        sCommand = sCommand + ") t1 WHERE ApprovedDt IS NULL OR  ApprovedDt = ''";
        //Response.Write(sCommand);
        oReader = SqlHelper.ExecuteReader(connstring, CommandType.Text, sCommand);
        if (oReader.HasRows)
        {
            oReader.Read();
            //Response.Write(oReader["Name1"].ToString());
            sNextApprover = oReader["BACId"].ToString() + ";" + oReader["Name1"].ToString() + ";" + oReader["ApprovingLimit"].ToString();

        } oReader.Close();

        //RETURNS BACId;FullName;Approver Position
        return (sNextApprover);
    }
    ...
    protected void ShowApprover()
    {
        ...
        if (oReader.HasRows)
        {
            ...
            //ResponseClarifyTo.Value = oReader["Name1"].ToString();
        }
        oReader.Close();

        // RESPOND TO: Last Approver
        string[] Arr = NextApprover().Split(';');
        RespondTo.Value = Arr[1].ToString();


        // CLARIFY TO:
        sCommand = "SELECT BuyerId, BuyerLastName + ', ' + BuyerFirstName + ' ' + BuyerMidName AS Name1 FROM tblBuyers WHERE BuyerId = " + Session["BuyerBuyerId"];
        oReader = SqlHelper.ExecuteReader(connstring, CommandType.Text, sCommand);
        if (oReader.HasRows)
        {
            oReader.Read();
            ClarifyTo.Value = oReader["Name1"].ToString();
        }
        oReader.Close();

        lblPurchasingDate.Text = "<br />";
        sCommand = "SELECT MAX(DatePosted) DatePosted FROM tblBACClarifications ";
        sCommand = sCommand + "WHERE BidRefNo=" + Session["BuyerBidForBac"] + " AND FrUserId=" + Session["ClarifiedBy"].ToString();
        oReader = SqlHelper.ExecuteReader(connstring, CommandType.Text, sCommand);
        if (oReader.HasRows)
        {
            oReader.Read();
            DateTime date1 = DateTime.Parse(oReader["DatePosted"].ToString());
            lblPurchasingDate.Text = String.Format("{0:MMMM dd, yyyy}", date1);
        }
        oReader.Close();
    ...
    protected void DeleteAttachment(string sOperation, string iFileUploadID)
    {
        ...
        if (oReader.HasRows)
        {
            oReader.Read();
            sCommand = (string)oReader["ActualFileName"];
            FileInfo delFile = new FileInfo(Constant.FILEATTACHMENTSFOLDERDIR + Session["BuyerBuyerId"] + "\\BAC\\" + sCommand + ".gz");
            if (delFile.Exists)
            {
                File.Delete(Constant.FILEATTACHMENTSFOLDERDIR + Session["BuyerBuyerId"] + "\\BAC\\" + sCommand + ".gz");
            }
    ...
    protected void gvItems_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        if (e.CommandName.Equals("AddItemRow"))
        {
            ...
            //sCommand = sCommand + "CONVERT(NUMERIC(18, 2), UnitCost) UnitCost, CONVERT(NUMERIC(18, 2), UnitCost * Qty) TotalCost, CONVERT(NUMERIC(18, 2), UnitCost * Qty) TotalCostPhp, Ranking, fromDB, UnitMeasure, VendorName, Currenzy, " + Session["BuyerBuyerId"].ToString() + " UserId FROM (";
            ...
            //sCommand = sCommand + "WHERE BidDetailNo NOT IN (SELECT BidDetailNo FROM tblBACEvaluationDetails WHERE BidRefNo = " + Session["BuyerBidForBac"] + " AND UserId=" + Session["BuyerBuyerId"] + ") ";
            ...
            //sCommand = sCommand + "SELECT BidRefNo, BidDetailNo, CONVERT(VARCHAR, BidTenderNo) BidTenderNo, SKU, ItemName, Chkd, Qty, ";
            //sCommand = sCommand + "CONVERT(NUMERIC(18, 2), UnitCost) UnitCost, CONVERT(NUMERIC(18, 2), UnitCost * Qty) TotalCost, Ranking, fromDB, UnitMeasure, VendorName, Currenzy, " + Session["BuyerBuyerId"].ToString() + " UserId FROM (";
        ...
        {
            sCommand = "DELETE FROM tblBACEvaluationDetails WHERE BidRefNo=" + Session["BuyerBidForBac"] + " AND UserId=" + Session["BuyerBuyerId"] + " ";
        ...
        lstCommDetails.DataSourceID = null;
        lstCommDetails.DataSourceID = "dsItems1";
        dsItems1.SelectCommand = "SELECT DISTINCT BidDetailNo, ItemName, SKU FROM tblBACEvaluationDetails WHERE BidRefNo = " + Session["BuyerBidForBac"] + " AND UserId=" + Session["BuyerBuyerId"] + " AND BidDetailNo=" + e.CommandArgument.ToString() + " ORDER BY BidDetailNo, ItemName, SKU";
    ...
    private bool SendEmailNotificationApprove(int FromId, int ToId)
    {
        ...
        //sCommand = "SELECT t1.PurchasingID, t2.FirstName + ' ' + t2.MiddleName + ' ' + t2.LastName AS Name1, t2.EmailAdd FROM tblSupervisor t1 ";
        //sCommand = sCommand + "INNER JOIN tblPurchasing t2 ON t1.PurchasingID=t2.PurchasingID WHERE BuyerID=" + Session["BuyerBuyerId"] + " ";
        //oReader = SqlHelper.ExecuteReader(connstring, CommandType.Text, sCommand);
        //if (oReader.HasRows)
        //{
        ...
        //// RESPOND TO: Last Approver
        //sCommand = "SELECT BacID, FirstName + ' ' + MiddleName + ' ' + LastName AS Name1, EmailAdd FROM tblBidAwardingCommittee WHERE BacID = (SELECT TOP 1 BACId FROM (Select * From vwBacBidApprovers WHERE BidRefNo=" + Session["BuyerBidForBac"] + ") t1 WHERE ApprovedDt IS NULL OR  ApprovedDt = '')";
        //oReader = SqlHelper.ExecuteReader(connstring, CommandType.Text, sCommand);
        //if (oReader.HasRows)
        //{
        //    oReader.Read();
    ...
    private string CreateNotificationBodyApprove(string fromName1, string toName1)
    {
        ...
        sCommand = sCommand + "FROM tblBACEvaluationDetails WHERE BidRefNo=" + Request.Form["BuyerBidForBac"] + " AND Chkd=1";
        oReader = SqlHelper.ExecuteReader(connstring, CommandType.Text, sCommand);
        if (oReader.HasRows)
        {
            while (oReader.Read())
        ...
        sb.Append("<tr><td><p><strong>BAC for Approval</strong> <br> Sent: " + DateTime.Now.ToLongDateString() + "</p> <p>From: " + FromName + "<br><br> To: " + ToName + "<br><br> Subject: " + Request.Form["ItemDescLbl"] + "<br><br> Dear Bid Award Approvers, <br><br> Re: Request for Bid Award Approval – <strong>" + Request.Form["ItemDescLbl"] + "</strong><br><br> This is to request for your Bid Award Approval of the ff:<br><br> <b>Bid Reference Number:</b> " + Request.Form["BuyerBidForBac"] + "<br> <b>Bid Event Name:</b> " + Request.Form["ItemDescLbl"] + "<br> </p> " + sTxt + "  <p>Very truly yours,<br><br><br> <strong>e-Sourcing Procurement</strong></p><p>&nbsp;</p> <p><strong>Instructions:</strong></p> <ol> <li>Go to <a href='https://e-sourcing.globe.com.ph/'>https://e-sourcing.globe.com.ph</a></li> <li>Enter your Username and Password then  click Login</li> <li>Click Received Bid Events for Awarding</li> <li>Click Bid Events Name</li> <li>Review / Endorse / Approve Bid event  for Awarding</li> <li>Click Clarify if you have clarification  or click Approved to award Bid Events</li> </ol> Please do not reply to this auto-generated  message.&nbsp;</td></tr>");
    ...
    private bool SendEmailNotificationClarify(int FromId, int ToId)
    {
        ...
        //// GET BUYER AS RECEPIENT
        //sCommand = "SELECT BuyerId, BuyerFirstName + ' ' + BuyerMidName + ' ' + BuyerLastName AS Name1, EmailAdd FROM tblBuyers WHERE BuyerId = " + Session["BuyerBuyerId"];
        //oReader = SqlHelper.ExecuteReader(connstring, CommandType.Text, sCommand);
        //if (oReader.HasRows)
        //{
        //    oReader.Read();
    ...
    private string CreateNotificationBodyClarify(string FromName1, string ToName1)
    {
        StringBuilder sb = new StringBuilder();
        ...
        //sb.Append("<tr><td align='right'><h5>" + DateTime.Now.ToLongDateString() + "</h5></td></tr>");
        sb.Append("<tr><td><p><strong>BAC for Clarification</strong> <br> Sent: " + DateTime.Now.ToLongDateString() + "</p> <p>From: " + FromName + "<br><br> To: " + ToName + "<br><br> Attention:<br> Re: Request for Clarification - " + Request.Form["ItemDescLbl"] + "<br><br> Dear " + ToName + ", <br><br> There is a request for clarification on Bid for Award as follows:<br><br> <b>Bid Reference Number:</b> " + Session["BuyerBidForBac"] + "<br> <b>Bid Event Name:</b> " + Request.Form["ItemDescLbl"] + "<br><br></p>  <p>Very truly yours,<br><br><br> <strong>e-Sourcing Procurement</strong></p><p>&nbsp;</p> <p><strong>Instructions:</strong></p> <ol> <li>Go to <a href='https://e-sourcing.globe.com.ph/'>https://e-sourcing.globe.com.ph</a></li> <li>Enter your Username and Password then  click Login</li> <li>Click Bid Award for clarification</li> <li>Click Bid Events Name</li> <li>See Remarks / Comments box for items to clarify</li> <li>Click Clarify & provide response to Clarification</li> </ol> Please do not reply to this auto-generated  message.&nbsp;</td></tr>");
    ...
    //SEND EMAIL TO DRAFT
    //#############################################################################
    private bool SendEmailNotificationDraft()
    {
        string sCommand;
        string connstring = ConfigurationManager.ConnectionStrings["EBidConnectionString"].ConnectionString;
        SqlDataReader oReader;
    ...
    private string CreateNotificationBodyDraft()
    {
        StringBuilder sb = new StringBuilder();
        ...
        //sb.Append("<tr><td align='right'><h5>" + DateTime.Now.ToLongDateString() + "</h5></td></tr>");
        sb.Append("<tr><td><p><strong>BAC Drafted</strong> <br> Sent: " + DateTime.Now.ToLongDateString() + "</p> <p>From: " + BuyersName1 + "<br><br> To: " + PurchasingName1 + "<br><br> Attention:<br> Re: Notice of Drafted BAC: " + Request.Form["ItemDescLbl"] + "<br><br> Dear " + PurchasingName1 + ", <br><br> This is to inform Buyer that the following BAC was drafted:</b> " + Session["BuyerBidForBac"] + "<br> <b>Bid Event Name:</b> " + Request.Form["ItemDescLbl"] + "<br><br></p>  <p>Very truly yours,<br><br><br> <strong>e-Sourcing Procurement</strong></p><p>&nbsp;</p> <p><strong>Instructions:</strong></p> <ol> <li>Go to <a href='https://e-sourcing.globe.com.ph/'>https://e-sourcing.globe.com.ph</a></li> <li>Enter your Username and Password then  click Login</li> <li>Click Bid Award for clarification</li> <li>Click Bid Events Name</li> <li>See Remarks / Comments box for items to clarify</li> <li>Click Clarify & provide response to Clarification</li> </ol> Please do not reply to this auto-generated  message.&nbsp;</td></tr>");
