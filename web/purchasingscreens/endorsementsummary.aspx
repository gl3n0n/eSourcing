<%@ page language="C#" autoeventwireup="true" inherits="web_purchasing_screens_EndorsementSummary, App_Web_endorsementsummary.aspx.9bdd8cc1" theme="default" %>
                                                ...
                                                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                    <tr>
                                                        <td id="content0">
                                                            ...
                                                            <br />
                                                            <asp:LinkButton ID="lnkConvert" runat="server" Text='Convert to Auction' CommandName="ConvertItem"  OnClick="lnkConvert_Click">
                                                            </asp:LinkButton>
                                                            <div align="left">
                                                                <asp:DetailsView ID="dvEventDetails" runat="server" AutoGenerateRows="False" DataSourceID="dsEventDetails" Width="100%" CssClass="itemDetails" HeaderText="Details" HeaderStyle-BackColor="#10659E" HeaderStyle-ForeColor="white"
                                                                    ...
                                                                    <Fields>
                                                                        <asp:BoundField DataField="BidDetailNo" HeaderText="Bid Detail No." InsertVisible="False" ReadOnly="True" SortExpression="BidTenderNo">
                                                                ...
                                                                <asp:GridView Width="100%" runat="server" ID="gvTenders" SkinID="AuctionedItems" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" EmptyDataText="No Bid Tenders." DataSourceID="dsTenders"
                                                                    ...
                                                                    <Columns>
                                                                        ...
                                                                        <asp:TemplateField>
                                                                            ...
                                                                            <ItemTemplate>
                                                                                <asp:Panel ID="pnlCommands" runat="server" Visible='<%# IsPanelVisible(Eval("Status", "{0}")) %>' HorizontalAlign="Center">
                                                                                    <asp:LinkButton ID="lnkDetails" runat="server" CommandName="Select" CommandArgument='<%# Bind("BidTenRef") %>'>Details</asp:LinkButton>&nbsp;|
                                                                                    <asp:LinkButton ID="lnkAward" runat="server" Text='Award' CommandName="SetComments" CommandArgument="Award" ToolTip="Click to award this tender.">    
                                                                                    </asp:LinkButton>&nbsp;|
                                                                                    <asp:HiddenField ID="hdnVendorId" runat="server" Value='<%# Bind("VendorId") %>'/>
                                                                                    <asp:LinkButton ID="lnkRenegotiate" runat="server" Text='Clarify' CommandName="SetComments" CommandArgument="Renegotiate" ToolTip="Click to send this tender to buyer for clarification.">
                                                                                    </asp:LinkButton>
                                                                                </asp:Panel>
                                                                                <asp:Panel ID="pnlComments" runat="server" Visible='false' HorizontalAlign="Center">
                                                                                    ...
                                                                                    <asp:TextBox ID="txtComment" runat="server" TextMode="MultiLine" Rows="4" Font-Names="Arial" Font-Size="11px"></asp:TextBox><br />
                                                                                ...
                                                                                <asp:Label ID="lblAwarded" Text='Winner' runat="server" Visible='<%# IsAwardedVisible(Eval("Status", "{0}")) %>'></asp:Label>
                                                                                <asp:Label ID="lblForRenegotiation" Text='For Clarification' runat="server" Visible='<%# IsRenegotiateVisible(Eval("Status", "{0}")) %>'></asp:Label>
                                                                            </ItemTemplate>
                                                                        </asp:TemplateField>
                                                                    </Columns>
                                                                </asp:GridView>
                                                                <asp:SqlDataSource ID="dsTenders" runat="server" ConnectionString="<%$ ConnectionStrings:EBidConnectionString %>" SelectCommand="sp_GetItemTenderEndorsements" SelectCommandType="StoredProcedure">
                                                                    <SelectParameters>
                                                                        <asp:SessionParameter Name="BidDetailNo" SessionField="BidDetailNo" Type="Int32" />
                                                                    </SelectParameters>
                                                                </asp:SqlDataSource>
                                                            ...
                                                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                <tr>
                                                                    <td align="center">
                                                                        <asp:Panel ID="pnlCommentBox" Visible="false" runat="server">
                                                                            <p style="text-align: center;">
                                                                                <br />
                                                                                Comment<br />
                                                                                <asp:TextBox ID="txtComment2" runat="server" TextMode="MultiLine" Rows="4" Font-Names="Arial" Font-Size="11px" Width="200"></asp:TextBox><br />
                                                                                <asp:RequiredFieldValidator ID="rfvCommment2" runat="server" ErrorMessage="Comment is required<br>" ControlToValidate="txtComment2" Font-Size="11px" Display="Dynamic" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                                                                <asp:LinkButton ID="lnkConvertNow" runat="server" OnClientClick="return confirm('Are you sure you convert this item to auction?')" OnClick="lnkConvertNow_Click">Convert</asp:LinkButton>&nbsp;
                                                                                <asp:LinkButton ID="lnkCancelConvert" runat="server" OnClick="lnkCancelConvert_Click" CausesValidation="false">Cancel</asp:LinkButton></p>
                                                                        </asp:Panel>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                            ...
                                                            <table border="0" cellpadding="0" cellspacing="0" width="100%" id="actions">
                                                                <tr>
                                                                    <td>
																		<asp:LinkButton ID="lnkCloseBid" runat="server" Width="120px" Text="Finish Awarding" OnClientClick="return confirm('Are you sure you want to close this bid item?')" onClick="lnkCloseBid_Click"></asp:LinkButton>
                                                                        <asp:HyperLink ID="lnkComparison" runat="server" Width="160px">Comparison By Bid Item</asp:HyperLink>
                                                                        <asp:LinkButton runat="server" ID="lnkCancel" Text="Back" OnClick="lnkCancel_Click" CausesValidation="false" Width="100px"></asp:LinkButton>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                            <p>
