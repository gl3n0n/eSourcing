<%@ page language="C#" autoeventwireup="true" inherits="web_purchasing_vsfview, App_Web_vsfview_endorsed.aspx.9bdd8cc1" enableviewstate="true" maintainscrollpositiononpostback="true" theme="default" %>
	...
	font-family:Arial, sans-serif;
                                                     ...
                                                     <asp:Repeater ID="repeaterVSFComments" runat="server" DataSourceID="dsVSFComments">
                                                        ...
                                                        <p><strong><%# Eval("Name")%></strong>&nbsp;&nbsp;&nbsp;<em><%# Eval("DateCreated")%></em><br /><%# Eval("Comment") %></p>
                                                         ...
                                                         <textarea id="Comment" cols="80" name="Comment" rows="8" style="font-family:Arial"></textarea></td>
                                                     </tr>
                                                ...
                                                <table border="0" cellpadding="0" cellspacing="0" width="100%" id="actions">
                                                    <tr>
                                                        <td align="right">
                                                            ...
                                                            <input id="btnClarify" type="button" value="Clarify" onclick="if(confirm('Are you sure to clarify this vendor shortlisting?')){ if($('#Comment').val()==''){ alert('Dont forget to comment!'); $('#Comment').focus(); } else { __doPostBack('Clarify'); }  }" />
