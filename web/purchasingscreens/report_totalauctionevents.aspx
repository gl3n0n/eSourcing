<%@ page language="C#" autoeventwireup="true" inherits="web_purchasingscreens_report_totalauctionevents, App_Web_report_totalauctionevents.aspx.9bdd8cc1" theme="default" %>
                                                ...
                                                <tr>
                                                    <td colspan="2" style="height: 10px;">
                                                        <asp:GridView ID="gvBids" runat="server" SkinID="BidEvents" AllowPaging="True" AllowSorting="True"
                                                            AutoGenerateColumns="False" DataKeyNames="CompanyId" DataSourceID="dsTotalAuctionEvents"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField HeaderText="Number of Auction Events" SortExpression="CntAuctionEvents">
                                                                    <HeaderStyle HorizontalAlign="Center" />
                                                                    <ItemStyle HorizontalAlign="center" />
                                                                    <ItemTemplate>
                                                                        &nbsp;<asp:LinkButton ID="lnkCntAuctionEvents" runat="server" Text='<%# Bind("CntAuctionEvents") %>'
                                                                            CommandArgument='<%# Bind("CompanyId") %>' CommandName='<%# Bind("Company") %>'></asp:LinkButton>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                            </Columns>
                                                        </asp:GridView>
                                                        <asp:SqlDataSource ID="dsTotalAuctionEvents" runat="server" ConnectionString="<%$ ConnectionStrings:EBidConnectionString %>"
                                                            SelectCommand="sp_GetBuyerCntApprovedAuctionEventsByCompany" SelectCommandType="StoredProcedure">
                                                            <SelectParameters>
