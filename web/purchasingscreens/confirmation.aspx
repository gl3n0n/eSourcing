<%@ page language="C#" autoeventwireup="true" inherits="web_purchasing_screens_bidConfirmation, App_Web_confirmation.aspx.9bdd8cc1" enableeventvalidation="true" theme="default" %>

<%@ Register Src="../usercontrol/bids/biddetails.ascx" TagName="biddetails1" TagPrefix="uc1" %>
...
<body>
    <div align="left">
        <form id="Form1" runat="server" defaultbutton="lnkOK">
                                                ...
                                                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                    <tr>
                                                        <td id="content0">
                                                            ...
                                                            <div align="left">
                                                                <uc1:biddetails1 ID="Biddetails2" runat="server" />
                                                            </div>
                                                            <br />
