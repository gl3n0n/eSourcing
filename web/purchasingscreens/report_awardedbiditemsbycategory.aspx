<%@ page language="C#" autoeventwireup="true" inherits="web_purchasingscreens_report_awardedbiditemsbycategory, App_Web_report_awardedbiditemsbycategory.aspx.9bdd8cc1" theme="default" %>

<%@ Register Src="../usercontrol/reports/awardedbiditemsbycategory.ascx" TagName="awardedbiditemsbycategory" TagPrefix="uc2" %>
                            ...
                            <tr>
                                ...
                                <td id="content">
                                    <div align="left">
                                        <br />
                                        <h1>
                                            Awarded Bid Items By Category</h1>
                                        <div>
                                            <br />
                                            <uc2:awardedbiditemsbycategory ID="Awardedbiditemsbycategory1" runat="server" />
                                        </div>
                                    </div>
                                </td>
                            </tr>
