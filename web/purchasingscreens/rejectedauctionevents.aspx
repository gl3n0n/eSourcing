<%@ page language="C#" autoeventwireup="true" inherits="web_purchasing_screens_RejectedAuctionEvents, App_Web_rejectedauctionevents.aspx.9bdd8cc1" theme="default" %>
                                                ...
                                                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                    <tr>
                                                        <td id="content0">
                                                            ...
                                                            <asp:SqlDataSource ID="dsRejectedAuctions" runat="server" ConnectionString="<%$ ConnectionStrings:EBidConnectionString %>"
