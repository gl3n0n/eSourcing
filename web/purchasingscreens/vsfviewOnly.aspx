<%@ Page Language="C#" AutoEventWireup="true" CodeFile="vsfviewOnly.aspx.cs" Inherits="vsfviewOnly" EnableViewState="true" MaintainScrollPositionOnPostback="true"  %>
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                        <tr>
                                            <td valign="top">
												...
												<p><a href="javascript:void(0)" onclick="$('#relatedInfo').toggle()">Show/Hide Left Panel</a>
                                                <br /><asp:Label ID="lblMessage" runat="server" Font-Size="11px" ForeColor="red"></asp:Label></p>
                                                        ...
                                                        <table width="25%" border="1" cellpadding="0" cellspacing="0" rules="all" class="itemDetails" style="border-color:#71A9D2; font-family: Arial; font-size: 11px; border-collapse: collapse; background-color: rgb(219, 234, 245); height:100%">
																<tbody>
																	...
																	<tr valign="middle">
																		...
																		<td align="left" valign="middle" bgcolor="#FFFFFF">
																			<asp:Label ID="NumPotentialVendor" CssClass="numeric" runat="server" Text='' Font-Bold="True" Font-Size="10pt"></asp:Label>
																		</td>
																	</tr>
																	<tr valign="middle">
																		<td align="left" valign="middle" bgcolor="#FFFFFF" >PR Amount</td>
																		<td align="left" valign="middle" bgcolor="#FFFFFF" >
																			<asp:Label ID="PRAmount" CssClass="numeric" runat="server" Text='' Font-Bold="True" Font-Size="10pt"></asp:Label>
																		</td>
																		<td align="left" valign="middle" bgcolor="#FFFFFF" >No. of short-listed vendors</td>
																		<td align="left" valign="middle" bgcolor="#FFFFFF">
																			<asp:Label ID="NumShortlistedVendor" CssClass="numeric" runat="server" Text='' Font-Bold="True" Font-Size="10pt"></asp:Label>
																		</td>
																	</tr>
																	<tr valign="middle">
	...
	font-family:Arial, sans-serif;
                                                        ...
                                                        <table width="25%" border="1" cellpadding="5" cellspacing="0" rules="all" class="itemDetails" style="border-color:#71A9D2; font-family: Arial; font-size: 11px; border-collapse: collapse; background-color: rgb(219, 234, 245); height:100%">
																<tbody>
																	...
																	<tr valign="middle">
																		...
																		<td align="center" valign="middle" bgcolor="#FFFFFF"><asp:Label ID="SAPRatingScore" CssClass="numeric" runat="server" Text='<%# Eval("SAPRatingScore") %>' Font-Bold="True" Font-Size="10pt"></asp:Label></td>
																		<td align="center" valign="middle" bgcolor="#FFFFFF"><asp:Label ID="SAPRatingRank" CssClass="numeric" runat="server" Text='<%# Eval("SAPRatingRank") %>' Font-Bold="True" Font-Size="10pt"></asp:Label></td>
																		<td align="center" valign="middle" bgcolor="#FFFFFF"><asp:Label ID="MaxExposureLimit" CssClass="numeric" runat="server" Text='<%# Eval("MaxExposureLimit") %>' Font-Bold="True" Font-Size="10pt"></asp:Label></td>
																		<td align="center" valign="middle" bgcolor="#FFFFFF"><asp:Label ID="AmountUnservedPO" CssClass="numeric" runat="server" Text='<%# Eval("AmountUnservedPO") %>' Font-Bold="True" Font-Size="10pt"></asp:Label></td>
																		<td align="center" valign="middle" bgcolor="#FFFFFF"><asp:Label ID="AvailBalance" CssClass="numeric" runat="server" Text='<%# Eval("AvailBalance") %>' Font-Bold="True" Font-Size="10pt"></asp:Label></td>
																		<td align="center" valign="middle" bgcolor="#FFFFFF"><asp:Label ID="FCRank" CssClass="numeric" runat="server" Text='<%# Eval("FCRank") %>' Font-Bold="True" Font-Size="10pt"></asp:Label></td>
																	...
																	<tr valign="middle">
																		...
																		<td align="left" valign="middle" bgcolor="#FFFFFF" colspan="9"><%--<asp:Label ID="Recomendatation" runat="server" Text='<%# Eval("Recomendatation") %>' Font-Bold="True" Font-Size="10pt"></asp:Label>--%><textarea id="Recomendatation" cols="80" rows="5" runat="server" style='font-family:Arial'></textarea>
                                                                        </td>
																	</tr>
																</tbody>
															</table>
                                                     ...
                                                     <asp:Repeater ID="repeaterVSFComments" runat="server" DataSourceID="dsVSFComments">
                                                        ...
                                                        <p><strong><%# Eval("Name")%></strong>&nbsp;&nbsp;&nbsp;<em><%# Eval("DateCreated")%></em><br /><%# Eval("Comment") %></p>
                                                         ...
                                                         <span style="font-size:12px;">Comment :</span><br />
                                                         <textarea id="Comment" cols="80" name="Comment" rows="8" style="font-family:Arial" runat="server" ></textarea></td>
                                                     </tr>
                                                ...
                                                <table border="0" cellpadding="0" cellspacing="0" width="100%" id="actions">
                                                    <tr>
                                                        <td align="right">
                                                            <%--<input id="btnReject" type="button" value="Reject" onclick="if(confirm('Are you sure to reject this vendor shortlisting now?')){ __doPostBack('Reject'); }" />--%>
                                                            <input id="btnClarify" type="button" value="Clarify" onclick="if(confirm('Are you sure to clarify this vendor shortlisting?')){ if($('#Comment').val()==''){ alert('Dont forget to comment!'); $('#Comment').focus(); } else { __doPostBack('Clarify'); }  }" runat="server" />
                                                            <%--<input id="btnApprove" type="button" value="Approve" onclick="if(confirm('Are you sure to approve this vendor shortlisting?')){ if($('#Comment').val()==''){ alert('Dont forget to comment!'); $('#Comment').focus(); } else { __doPostBack('Approve'); }  }" />--%>
