<%@ page language="C#" autoeventwireup="true" inherits="web_purchasing_screens_AwardedAuctionItemDetails, App_Web_awardedauctionitemdetails.aspx.9bdd8cc1" theme="default" %>
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%" id="page0">
					                    <tr>
						                    ...
						                    <table border="0" cellpadding="0" cellspacing="0" width="100%" >
							                    <tr>
								                    <td id="content0">
								                        <h1><br />Auction Item Details</h1>										
								                        <div align="left">
                                                        </div>
                                                        <uc1:auctionitemdetail ID="Auctionitemdetail1" runat="server" />                                                        
                                                        <br />
                                                        <uc2:AwardedAuctionVendordetails ID="AwardedAuctionVendordetails1" runat="server" />                                                        
                                                        <br />
