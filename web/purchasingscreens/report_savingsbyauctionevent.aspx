<%@ page language="C#" autoeventwireup="true" inherits="web_purchasingscreens_report_savingsbyauctionitem, App_Web_report_savingsbyauctionevent.aspx.9bdd8cc1" theme="default" %>

<%@ Register Src="../usercontrol/reports/savingsbyauctionitem.ascx" TagName="savingsbyauctionitem" TagPrefix="uc2" %>
                            ...
                            <tr>
                                ...
                                <td id="content">
                                    <div align="left">
                                        <br />
                                        <h1>
                                            Savings By Auction Event</h1>
                                        <div>
                                            <br />                                            
                                            <uc2:savingsbyauctionitem ID="Savingsbyauctionitem1" runat="server" />
                                        </div>
                                    </div>
                                </td>
                            </tr>
