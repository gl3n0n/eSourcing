<%@ page language="C#" autoeventwireup="true" inherits="web_reports_totalbideventsitems, App_Web_totalbideventsitems.aspx.c8e5ce22" theme="default" %>
            ...
            <tr>
                <td valign="top" align="center" style="width: 1205px">
                    ...
                    <rsweb:ReportViewer ID="rvBidEvent" runat="server" Font-Names="Verdana" Font-Size="8pt" Width="920px" Height="780px" BackColor="WhiteSmoke" BorderWidth="1px" ShowDocumentMapButton="False"
                        ...
                        <LocalReport>
                            <DataSources>
                                <rsweb:ReportDataSource DataSourceId="ObjectDataSource1" Name="dsReportTotalBidEventsItems_sp_GetBuyerApprovedBidEventsByCompany" />
                            </DataSources>
                        </LocalReport>
                    </rsweb:ReportViewer>                    
                    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetData"
                        TypeName="dsReportTotalBidEventsItemsTableAdapters.sp_GetBuyerApprovedBidEventsByCompanyTableAdapter" OldValuesParameterFormatString="original_{0}">
                        <SelectParameters>
