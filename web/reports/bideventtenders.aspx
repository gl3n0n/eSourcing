<%@ page language="C#" autoeventwireup="true" inherits="web_reports_bideventtenders, App_Web_bideventtenders.aspx.c8e5ce22" theme="default" %>
        ...
        <table id="Table1" border="0" cellpadding="0" cellspacing="0" width="100%" height="100%">
            <tr>
                <td valign="top" align="center">
                    ...
                    <asp:SqlDataSource ID="sdsBidEventTenders" runat="server" ConnectionString="<%$ ConnectionStrings:EBidConnectionString %>" SelectCommand="sp_GetBidEventTenders" SelectCommandType="StoredProcedure">
                        <SelectParameters>
                            <asp:QueryStringParameter DefaultValue="0" Name="BidRefNo" QueryStringField="brn" Type="Int32" />
                        </SelectParameters>
                    </asp:SqlDataSource>
