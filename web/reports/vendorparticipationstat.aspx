<%@ Page Language="C#" AutoEventWireup="true" CodeFile="vendorparticipationstat.aspx.cs" Inherits="web_reports_vendorparticipationstat" %>
        ...
        <table id="Table1" border="0" cellpadding="0" cellspacing="0" width="100%" height="100%">
            <tr>
                <td valign="top" align="center" style="width: 1205px">
                    ...
                    <rsweb:ReportViewer ID="rvVendorParticipationStat" runat="server" Font-Names="Verdana" Font-Size="8pt" Width="920px" Height="780px" BackColor="WhiteSmoke" BorderWidth="1px" ShowDocumentMapButton="False"
                        ShowFindControls="False" ShowZoomControl="False" SizeToReportContent="True" ShowExportControls="False" ShowRefreshButton="False">                                                                        
                        <LocalReport ReportPath="web\reports\vendorparticipationstat.rdlc">
                            <DataSources>
                                <rsweb:ReportDataSource DataSourceId="ObjectDataSource1" Name="dsReportVendorParticipationStat_sp_Report_VendorParticipationStats" />
                            </DataSources>
                        </LocalReport>
                    </rsweb:ReportViewer>                    
                    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
                        SelectMethod="GetData" TypeName="dsReportVendorParticipationStatTableAdapters.sp_Report_VendorParticipationStatsTableAdapter">
                        <SelectParameters>
