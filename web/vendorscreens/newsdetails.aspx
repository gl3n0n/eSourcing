...
<%@ Register Src="../usercontrol/TopDate.ascx" TagName="TopDate" TagPrefix="uc3" %>
<%@ Register Src="../usercontrol/vendor/Vendor_TopNav_Home.ascx" TagName="Vendor_TopNav_Home" TagPrefix="uc4" %>
                    ...
                    <tr height="137px">
                        <td valign="top">
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                ...
                                <tr>
                                    <td>
                                        <uc4:Vendor_TopNav_Home ID="Vendor_TopNav_Home1" runat="server" />
                                    </td>
                                </tr>
                                <tr>
                                    <td style="background: black;">
                                        <uc3:TopDate ID="TopDate1" runat="server" />
                                    </td>
                                </tr>
                            </table>
                        </td>
