<%@ page language="C#" autoeventwireup="true" inherits="web_vendorscreens_ConfirmedInvitations, App_Web_confirmedinvitations.aspx.8a7237e8" theme="default" %>
...
string connstring = ConfigurationManager.ConnectionStrings["EBidConnectionString"].ConnectionString;
    ...
    private int SaveVendorAuditTrail()
    {
        ...
        try
        {
            ...
            sqlParams[4].Value = "Viewed list of confirmed auction invitations.";
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" width="100%" height="100%">
                            <tr>
                                ...
                                <td id="content">
                                    ...
                                    <asp:SqlDataSource ID="dsConfirmedInvitations" runat="server" ConnectionString="<%$ ConnectionStrings:EBidConnectionString %>"
