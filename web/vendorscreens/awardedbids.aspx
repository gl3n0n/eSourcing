<%@ page language="c#" inherits="EBid.web.vendor_screens.AwardedBids, App_Web_awardedbids.aspx.8a7237e8" theme="default" %>
...
string connstring = ConfigurationManager.ConnectionStrings["EBidConnectionString"].ConnectionString;
    ...
    private int SaveVendorAuditTrail()
    {
        ...
        try
        {
            ...
            sqlParams[4].Value = "Viewed list of awarded bid events.";
