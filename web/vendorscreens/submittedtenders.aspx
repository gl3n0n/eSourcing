<%@ page language="c#" inherits="EBid.web.vendor_screens.SubmittedTenders, App_Web_submittedtenders.aspx.8a7237e8" theme="default" %>
...
string connstring = ConfigurationManager.ConnectionStrings["EBidConnectionString"].ConnectionString;
    ...
    private int SaveVendorAuditTrail()
    {
        ...
        try
        {
            ...
            sqlParams[4].Value = "Viewed list of submitted bid tenders.";
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                        <tr>
                                            <td valign="top">
                                                <h1>
                                                    <br />
                                                    Submitted Bid Tenders</h1>
                                                <br />
                                                <asp:GridView ID="gvSubmittedTenders" runat="server" SkinID="BidEvents"
                                                    AutoGenerateColumns="False" AllowPaging="True" AllowSorting="True" 
                                                    OnRowCommand="gvSubmittedTenders_RowCommand" DataKeyNames="BidRefNo" DataSourceID="dsSubmittedTenders">
                                                    <Columns>
                                                        <asp:TemplateField HeaderText="Tender No." SortExpression="BidRefNo">
                                                            ...
                                                            <ItemTemplate>
                                                                ...
                                                                <asp:LinkButton ID="lnkTenderNo" runat="server" Text='<%# Bind("BidTenderNo") %>' CommandName="EditTender"
                                                                    CommandArgument='<%# Bind("BidDeadline", "{0}") %>' Width="90%" ToolTip="Click to view/edit bid tender for this bid item."></asp:LinkButton>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Bid Item" SortExpression="DetailDesc">
                                                            ...
                                                            <ItemTemplate>                                                                
                                                                &nbsp;<asp:LinkButton ID="lnkDetailDesc" runat="server" Text='<%# Bind("DetailDesc") %>' CommandName="EditTender"
                                                                    CommandArgument='<%# Bind("BidDeadline", "{0}") %>' ToolTip="Click to view/edit bid tender for this bid item."></asp:LinkButton>                                                                
                                                ...
                                                <asp:SqlDataSource ID="dsSubmittedTenders" runat="server" ConnectionString="<%$ ConnectionStrings:EBidConnectionString %>"
                                                    SelectCommand="sp_GetVendorBidTenderSubmitted" SelectCommandType="StoredProcedure">
                                                    <SelectParameters>
