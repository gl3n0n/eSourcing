<%@ page language="c#" enableeventvalidation="true" inherits="EBid.WEB.boc.newsdetails, App_Web_newsdetails.aspx.14769a0e" theme="default" %>

<%@ Register Src="../usercontrol/newsdetail.ascx" TagName="newsdetail" TagPrefix="uc4" %>
                    ...
                    <td>
                        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="height: 100%;">
                            <tr>
                                ...
                                <td id="content">
                                    <div align="left">
                                        <uc4:newsdetail ID="Newsdetail1" runat="server" />
                                    </div>
                                </td>
                            </tr>
                        </table>
