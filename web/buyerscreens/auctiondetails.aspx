<%@ page language="C#" autoeventwireup="true" inherits="web_buyerscreens_auctiondetails, App_Web_auctiondetails.aspx.1829e19c" theme="default" %>
                                        ...
                                        <tr>
                                            <td>
                                                <table border="0" cellpadding="0" cellspacing="0" width="100%" id="actions">
                                                    <tr>
                                                        <td>                                                            
                                                            <asp:LinkButton runat="server" ID="btnOK" OnClick="btnOK_Click" Width="100px">Back</asp:LinkButton>                                                            
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
