<%@ Page Language="C#" AutoEventWireup="true" CodeFile="bidawardingchecklist.aspx.cs" Inherits="web_buyerscreens_bidawardingchecklist" EnableViewState="true" MaintainScrollPositionOnPostback="true"  %>
<%@ Register TagPrefix="EBid" TagName="LeftNav" Src="~/WEB/usercontrol/Buyer/LeftNav.ascx" %><%@ Register TagPrefix="EBid" TagName="TopNavBids" Src="~/WEB/usercontrol/Buyer/TopNavBids.ascx" %><%@ Register TagPrefix="EBid" TagName="TopNav3" Src="~/WEB/usercontrol/Buyer/TopNav3.ascx" %><%@ Register TagPrefix="EBid" TagName="GlobalLinksNav" Src="~/web/usercontrol/GlobalLinksNav.ascx" %><%@ Register TagPrefix="EBid" TagName="Footer" Src="~/web/usercontrol/Footer.ascx" %><!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" ><html xmlns="http://www.w3.org/1999/xhtml"><head><title id="PageTitle" runat="server"></title><meta http-equiv="Content-Language" content="en-us" /><meta http-equiv="Content-Type" content="text/html; charset=windows-1252" /><script type="text/javascript" src="../../jquery/jquery-1.7.1.min.js"></script><script type="text/javascript" src="../../jquery/ui/jquery.ui.core.js"></script><script type="text/javascript" src="../../jquery/ui/jquery.ui.widget.js"></script><script type="text/javascript" src="../../jquery/ui/jquery.ui.mouse.js"></script><script type="text/javascript" src="../../jquery/ui/jquery.ui.tabs.js"></script><script type="text/javascript" src="../../jquery/ui/jquery.ui.button.js"></script><script type="text/javascript" src="../../jquery/ui/jquery.ui.draggable.js"></script><script type="text/javascript" src="../../jquery/ui/jquery.ui.position.js"></script><script type="text/javascript" src="../../jquery/ui/jquery.ui.dialog.js"></script><script type="text/javascript" src="../../jquery/ui/jquery.ui.datepicker.js"></script><!--<script type="text/javascript" src="../../jquery/ui/jquery.effects.slide.js"></script>--><link rel="stylesheet" href="../../jquery/themes/redmond/jquery.ui.all.css" type="text/css" /><link href="../css/style.css" rel="stylesheet" type="text/css" /><link rel="stylesheet" type="text/css" href="../css/style.css" /><link rel="stylesheet" type="text/css" href="../css/style_buyer.css" /><script type="text/javascript">
    ...
    </style></head><body id="Body1" runat="server"><div>
																...
																<tbody>
																	...
																	<tr valign="middle">
																		...
																		<td align="center" valign="middle" bgcolor="#FFFFFF" style="width:25%;">
																			<%--<asp:DropDownList runat="server" ID="ddlCurrency"  DataSourceID="dsCurrencies" DataTextField="Currency" DataValueField="IdRate" OnDataBound="ddlCurrency_DataBound">
																		</asp:DropDownList>
...
<asp:Label ID="EstItemValueLblCurr" runat="server" Text=""></asp:Label>

                                                                             <asp:TextBox ID="EstItemValueLbl" runat="server" Text="0" Width="125px" 
																	...
																	<tr valign="middle">
																		<td colspan="2" align="center" valign="middle" style="width:25%;">
																			<table width="100%" border="0" cellspacing="0" cellpadding="0">
																				<tr>
																					<td class="auto-style1"><input type="radio" runat="server" id="Budgeted" name="Budgeted" value="1" checked="true" />
                                                                        ...
                                                                        <div id="collapseAPR">
                                                                            <asp:Repeater ID="Repeater_SDA_APR" runat="server" DataSourceID="dsSDA_APR" OnItemDataBound="Repeater_SDA_APR_ItemDataBound">
                                                                                ...
                                                                                <div style="clear:both">
                                                                                    ...
                                                                                    <a id="lnkSDA_APR" href="bidawardingchecklist.aspx?ShowAttachment=<%# Eval("FileUploadID") %>"
                                                                        ...
                                                                        <div id="collapseABC">
                                                                            <asp:Repeater ID="Repeater_SDA_ABC" runat="server" DataSourceID="dsSDA_ABC" OnItemDataBound="Repeater_SDA_ABC_ItemDataBound">
                                                                                ...
                                                                                <div style="clear:both">
                                                                                    ...
                                                                                    <a href="bidawardingchecklist.aspx?ShowAttachment=<%# Eval("FileUploadID") %>"
                                                                                        target="_blank" title='<%# Eval("ActualFileName") %>'>
                                                                                        <%# Eval("OriginalFileName") %></a></div>
                                                                                </ItemTemplate>
                                                                            </asp:Repeater>
																...
																<tbody>
																	...
																	<tr>
                                                                        ...
                                                                        <script type="text/javascript">
                                                                            ...
                                                                            <%--<asp:LinkButton ID="SaveVendors" runat="server" Font-Bold="True">Save Vendors</asp:LinkButton>--%>
																		</td>
																	</tr>
																</tbody>
															</table>
                                                                                ...
                                                                                <table border="0" cellpadding="0" cellspacing="0"><tbody>
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <asp:Repeater id="rptUnitCost" runat="server" DataSourceID="dsBidItemTendersDetails_UnitCost" >
																					        <ItemTemplate>
                                                                                                <td style="width:150px" bgcolor="#E4EFF8">
																						            <asp:TextBox ID="txtUnitCost" runat="server" Width="85" Text='<%# String.Format("{0:#,##0.00}", Convert.ToDouble(Eval("UnitCost"))) %>' style="text-align:right" CssClass="clickCost"></asp:TextBox>
                                                                                                    <asp:TextBox ID="txtBidTenderNo1" runat="server" Text='<%# Eval("BidTenderNo") %>' Visible="false" ></asp:TextBox>
                                                                                                    <asp:TextBox ID="txtVendorName2" runat="server" Text='<%# Eval("VendorName") %>' Visible="false" ></asp:TextBox>
                                                                                                </td>
																					        </ItemTemplate>
                                                ...
                                                <table border="0" cellpadding="0" cellspacing="0" width="100%" id="actions">
                                                    <tr>
                                                        <td align="right">
                                                            ...
                                                            <%--<asp:Button ID="btnCancel" runat="server" Text="Cancel" OnClientClick="if(confirm('This will delete the current session. Continue?')){ document.getElementById('status').value=-1;  $('#form1').submit(); }" />--%>
