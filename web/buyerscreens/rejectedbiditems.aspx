<%@ page language="C#" autoeventwireup="true" inherits="WEB_buyer_screens_RejectedBidItems, App_Web_rejectedbiditems.aspx.1829e19c" theme="default" %>
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" width="100%" id="table4">
                                            <tr>
                                                <td>
                                                    ...
                                                    <p>
                                                        These are your rejected bid events.
                                                        Click on the bid event reference number or the bid event description to view the details of that event.
                                                    </p>
                                                    <asp:GridView ID="gvRejectedBids" runat="server" SkinID="BidEvents" AllowPaging="True"
                                                        AllowSorting="True" AutoGenerateColumns="False" OnRowCommand="gvRejectedBids_RowCommand" DataKeyNames="BidRefNo" DataSourceID="dsRejected">
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="Date Rejected" SortExpression="DateRejected">
                                                                ...
                                                                <ItemTemplate>
                                                                    &nbsp;<asp:Label ID="Label3" runat="server" Text='<%# Bind("DateRejected", "{0:D}<br />{0:T}") %>'></asp:Label>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>                                                            
                                                        </Columns>
                                                    </asp:GridView>
                                                    <asp:SqlDataSource ID="dsRejected" runat="server" ConnectionString="<%$ ConnectionStrings:EBidConnectionString %>"
                                                        SelectCommand="sp_GetBuyerRejectedBidEvents" SelectCommandType="StoredProcedure">
                                                        <SelectParameters>
