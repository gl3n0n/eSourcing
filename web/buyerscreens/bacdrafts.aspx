<%@ Page Language="C#" AutoEventWireup="true" CodeFile="bacdrafts.aspx.cs" Inherits="web_buyer_screens_ApprovedBidItems" %>
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" width="100%" id="table4">
                                            <tr>
                                                <td>
                                                    ...
                                                    <p>
                                                        These are your BAC 
                                                        drafts. Click on the BAC reference number or the BAC event description to view the details.<br />
                                                    ...
                                                    <asp:SqlDataSource ID="dsAproved" runat="server" ConnectionString="<%$ ConnectionStrings:EBidConnectionString %>" 
                                                        SelectCommand="SELECT BacRefNo, BidRefNo, ItemDesc, PreparedDt, CONVERT(VARCHAR, BidRefNo)+';'+CONVERT(VARCHAR, BacRefNo) AS BACBID FROM tblBacBidItems WHERE BuyerID=@BuyerID AND Status=@Status ORDER BY PreparedDt DESC" 
