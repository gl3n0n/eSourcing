...
<body id="Body1" runat="server">
    <div>
        ...
        <input type="hidden" id="txtDraft" name="txtDraft" runat="server" />
                                                ...
                                                <table cellspacing="5" style="width:100%;">
                                                    <tr>
                                                        <td colspan="2" valign="top">
															...
															<asp:SqlDataSource ID="dsBuyerBidDetailsForBac" runat="server" ConnectionString="<%$ ConnectionStrings:EBidConnectionString %>" SelectCommand="sp_BacBuyerBidDetails" SelectCommandType="StoredProcedure" ><%--SelectCommand="SELECT t1.*, t3.Company FROM tblBidItems t1 INNER JOIN rfcCompany t3 ON t3.CompanyId = t1.CompanyId WHERE t1.Status = @Status
																					...
																					<td style="border:none">
																						<table>
																							...
																							<tr>
																								...
																								<td>
                                                                                                    <input name="ss_crcnumber" type="text" id="ss_crcnumber" size="12" runat="server"  style="text-align:left; font-weight:bold" />
																							    </td>
                                                                                            </tr>
																						</table>
																					</td>
        ...
        $('#collapseBFAOth').is(':visible') ? $('#btcollapseBFAOth').html('- Others') : $('#btcollapseBFAOth').html('+ Others');
                                                                  ...
                                                                  <tr>
                                                                    ...
                                                                    <table style="width: 100%;">
                                                                            <tr>
                                                                                <td style="border:none">
                                                                                    <asp:CheckBox ID="LowestPriceBidder" runat="server" /><strong><a id="btcollapseLowestPr" href="javascript:void(0)" onclick="$('#collapseLowestPr').toggle(); showhideBT2();" style="color:Black;">- Lowest-Price Bidder</a> </strong> 
                                                                                </td>
                                                                                <td width="15" style="border:none">
																			...
																			<div style="overflow:auto; padding:0px; height:270px;" id="divContainer1">
                                                                                ...
                                                                                <tbody>
																					...
																					<tr runat="server" id="trHidden">
																						<td runat="server"><h3 style="border:none; color:#000"></h3>
                                                ...
                                                <table border="0" cellpadding="0" cellspacing="0" width="100%" id="actions">
                                                    <tr>
                                                        <td align="right">
                                                            ...
                                                            <input id="btnClarify" type="button" value="Clarify" onclick="document.getElementById('status').value=2; ShowClarify();" runat="server" />
