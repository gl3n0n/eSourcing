<%@ page language="C#" autoeventwireup="true" inherits="web_buyerscreens_vsfclarify, App_Web_vsfclarfiy.aspx.1829e19c" enableviewstate="true" maintainscrollpositiononpostback="true" theme="default" %>
...
.font5
	...
	font-family:Arial, sans-serif;
                                                        ...
                                                        <table width="25%" border="1" cellpadding="5" cellspacing="0" rules="all" class="itemDetails" style="border-color:#71A9D2; font-family: Arial; font-size: 11px; border-collapse: collapse; background-color: rgb(219, 234, 245); height:100%">
																<tbody>
																	<tr>
																		<td colspan="12" class="style1" style="vertical-align:middle;">Shortlisting Criteria</td>
																	</tr>
																	<tr valign="middle">
																	...
																	<tr valign="middle">
																		...
																		<td align="center" valign="middle" bgcolor="#FFFFFF"><input id="VendorId" type="hidden" runat="server" value='<%# Eval("VendorId")%>' /><%# Eval("VendorName")%></td>
                                                                        ...
                                                                        <%--<input id="ProductTypeApproval" type="text" runat="server" style="width:70px;" value='<%# Eval("ProductTypeApproval")%>' />--%>
                                                                        </td>
																		<td align="center" valign="middle" bgcolor="#FFFFFF"><input id="OverallRanking" type="text" runat="server" style="width:70px; text-align:right"  value='<%# Eval("OverallRanking")%>' class="integer" /></td>
																	</tr>
                                                                    </ItemTemplate>
                                                                    </asp:Repeater>
																	<tr valign="middle">
																		<td align="center" valign="middle" bgcolor="#71a8d1" colspan="3" style="color:#fff; vertical-align:middle">
                                                                            Summary of Recommendation</td>
																		<td align="left" valign="middle" bgcolor="#FFFFFF" colspan="9"><textarea id="Recomendatation" cols="80" rows="5" runat="server" style='font-family:Arial' runat="server"></textarea>
                                                                        </td>
                                                            ...
                                                            <asp:SqlDataSource ID="dsVendors" runat="server" ConnectionString="<%$ ConnectionStrings:EBidConnectionString %>"
																SelectCommand="SELECT '0' AS VendorId, '--SELECT A VENDOR--' as VendorName, '' as SupplierTypeDesc UNION SELECT t1.VendorId, t1.VendorName, t2.SupplierTypeDesc FROM tblVendors t1, rfcSupplierType t2 WHERE t2.SupplierTypeId = t1.Accredited ORDER BY VendorId" >
															</asp:SqlDataSource>
                                                    ...
                                                    <tr>
                                                        <td align="right">
                                                           <%-- <input id="btnCancel" type="button" value="Cancel VSF" onclick="if(confirm('This will delete the current session. Continue?')){ __doPostBack('Cancel'); }" />--%>
                                                            <input id="btnDraft" type="button" value="Clarify" onclick="if(confirm('Are you sure to clarify this vendor shortlisting?')){ if($('#Comment').val()==''){ alert('Dont forget to comment!'); $('#Comment').focus(); } else { __doPostBack('Clarify'); }  }" />
