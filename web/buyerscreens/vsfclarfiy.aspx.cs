...
public partial class web_buyerscreens_vsfclarify : System.Web.UI.Page
{
    ...
    void SaveToDB()
    {
        ...
        else
        {
            ...
            foreach (RepeaterItem oItem in oRpt.Items)
            {
                ...
                //System.Web.UI.HtmlControls.HtmlInputText ProductTypeApproval = ((System.Web.UI.HtmlControls.HtmlInputText)oItem.FindControl("ProductTypeApproval"));
