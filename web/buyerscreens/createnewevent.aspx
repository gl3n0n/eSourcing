...
<head>
	...
	function VSFlstSupplierB() 
    {
        var vsf = document.getElementById("VSF");
        var vsfval = vsf.options[vsf.selectedIndex].value;
...
<body onload="ShowPHPConversion(); VSFlstSupplierB();">
...
<%--																<tr>
																...
																<tr>
																	<td style="padding-top: 9px;">
																		VSF</td>
																	<td class="evenCells">
																		<asp:DropDownList ID="VSF" runat="server" DataSourceID="dsVSF" 
																			DataTextField="ProjectName" DataValueField="VSFId" AutoPostBack="True">
																		</asp:DropDownList>
                                                                        <asp:Label ID="VSFLink" runat="server" Text=""></asp:Label>
                                                                        <asp:SqlDataSource ID="dsVSF" runat="server" ConnectionString="<%$ ConnectionStrings:EBidConnectionString %>" SelectCommand="SELECT 0 VSFId, '--SELECT VSF--' ProjectName FROM tblVendorShortlistingForm UNION SELECT VSFId, ProjectName FROM tblVendorShortlistingForm WHERE (Status=3 OR Status=1) and BuyerID = @userId ORDER BY VSFId ASC" SelectCommandType="Text">
																	        <SelectParameters>
																		...
																		<asp:TemplateField HeaderText="&#160;Bid Items">
																			...
																			<ItemTemplate>
																				<table id="tblBidItem" runat="server" border="0" cellpadding="0" cellspacing="0" width="100%" style="font-family: Arial; font-size: 11px; border-bottom-width: 0;" visible='<%# (Eval("IsEmpty").ToString() == "1" ? true : false) %>'>
																					<tr>
																						<td width="50%">
																							&nbsp;<asp:Label ID="Label8" runat="server" Text='<%# Bind("PRGroupName", "PR Group: <b>{0}</b>")%>'></asp:Label><br />
																			...
																			<FooterTemplate>
																				<table cellpadding="0" cellspacing="0" width="100%" class="itemDetails_1" style="font-family: Arial; font-size: 11px; border-bottom-width: 0;">
                                                                                    <tr>
                                                                                        <td><span style="width: 75px;">&nbsp;PR Information</span>
																		                    <asp:DropDownList ID="PRInfo" runat="server" Width="250px" DataSourceID="dsPRInfo" 
																			                    DataTextField="GroupName" DataValueField="GroupName" AutoPostBack="True">
																		                    </asp:DropDownList>
                                                                                            <asp:Label ID="PRInfoLink" runat="server" Text=""></asp:Label>
																		                    <asp:SqlDataSource ID="dsPRInfo" runat="server" ConnectionString="<%$ ConnectionStrings:EBidConnectionString %>" SelectCommand="sp_GetPRGroup" SelectCommandType ="StoredProcedure">
                                                        											                    <SelectParameters>
															   ...
															   <asp:CheckBox ID="chkQualifiedSourcing" runat="server" Text="Qualified Sourcing"/> 
																<table cellspacing="0" cellpadding="0" width="100%" border="0" class="itemDetails_1">
																	<tbody>
																		...
																		<tr>
																			<td align="left">
																				<asp:ListBox Style="width: 900px; height: 200px" ID="lstSupplierA" runat="server" DataSourceID="dsVendors" DataTextField="VendorLabel" DataValueField="VendorId" SelectionMode="Multiple" OnDataBound="lstSupplierA_DataBound">
																				</asp:ListBox>
																			</td>
																			<td  align="center" style="width: 22px">
																				...
																				<input style="width: 20px" id="btnDeselectAll" type="button" value="<<" runat="server" onserverclick="btnDeselectAll_ServerClick" causesvalidation="false" /><br />
																			</td>
																		</tr>
																		<tr>
																			<td align="left">
																				<asp:ListBox Style="width: 900px; height: 200px" ID="lstSupplierB" runat="server" SelectionMode="Multiple" OnDataBound="lstSupplierB_DataBound"></asp:ListBox>
																			</td>
																		</tr>
																		<tr>
																			<td colspan="3">
																				<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:EBidConnectionString %>" SelectCommand="sp_GetVendorsInCategoryAndSubCategory" SelectCommandType="StoredProcedure">
																					<SelectParameters>
																		...
																		<tr>
																			<td colspan="2" style="font:9px Arial" align="left">(Name - Accreditation Status - Composite Rating - Maximum Exposure - Performance Rating) : (Right click vendor to view issue /s details)</td>																			
																		</tr>
																		<tr>
																			<td colspan="2" style="font:9px Arial" align="left">(For OTLS - (Name - Accreditation Status - Composite Rating - Maximum Exposure - Performance Rating) (Awarded Bid Events))</td>
																		</tr>
																	</tbody>
																</table>
															</p>
