<%@ page language="C#" autoeventwireup="true" inherits="web_buyer_screens_vsfdrafts, App_Web_vsfdrafts.aspx.1829e19c" theme="default" %>
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" width="100%" id="table4">
                                            <tr>
                                                <td>
                                                    <h1>
                                                        <br />
                                                        Drafts Vendor Shortlisting Form
                                                    </h1>
                                                    <p>
                                                        These are your Vendor Shortlisting Form 
                                                        drafts. Click on the Vendor Shortlisting Form reference number or the Vendor Shortlisting Form project name to view the details.<br />
