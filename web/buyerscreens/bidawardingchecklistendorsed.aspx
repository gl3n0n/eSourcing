                                                ...
                                                <table border="0" cellpadding="0" cellspacing="0" width="100%" id="actions">
                                                    <tr>
                                                        <td align="right">
                                                            ...
                                                            <input id="btnSendMail" runat="server" type="button" value="Resend Email" onclick="if (confirm('Are you sure to re-send email notificatins to pending approver?')) { __doPostBack('SendMail', ''); }" />
