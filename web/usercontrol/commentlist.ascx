<%@ control language="C#" autoeventwireup="true" inherits="web_usercontrol_commentlist, App_Web_commentlist.ascx.317b4283" %>
<div align="left" style="padding-left: 3px; text-align: justify;">
    ...
    <asp:SqlDataSource ID="dsComments" runat="server" ConnectionString="<%$ ConnectionStrings:EBidConnectionString %>"
        SelectCommand="sp_GetBidEventComments" SelectCommandType="StoredProcedure">
        <SelectParameters>
