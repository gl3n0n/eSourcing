<%@ control language="C#" autoeventwireup="true" inherits="web_user_control_Vendor_AuctionVendor_TopNav_Finished, App_Web_auctionvendor_topnav_finished.ascx.a5a12ffe" %>
