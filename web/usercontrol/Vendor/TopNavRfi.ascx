<%@ Control Language="C#" AutoEventWireup="true" CodeFile="TopNavRfi.ascx.cs" Inherits="web_usercontrol_buyer_TopNavRfi" %>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%" id="table2" class="topnav">
	<tr>		
        ...
        <td class="activeTab">
			<asp:HyperLink ID="lnk7" runat="server" NavigateUrl="~/web/buyerscreens/submittedrfiitems.aspx">RFI</asp:HyperLink>			
		</td>
		<td>&nbsp;</td>
	</tr>
</table>