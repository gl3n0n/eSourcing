<%@ control language="C#" autoeventwireup="true" inherits="web_user_control_Footer, App_Web_footer.ascx.317b4283" %>
<link type="text/css" href="../css/style.css" rel="stylesheet" />
Globe E-Bid Portal System<br />
Copyright © 2002 Globe Telecom, Inc. All rights reserved.<br />
...
<asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="http://www.globeplatinum.com.ph/" Target="_blank">Globe Platinum</asp:HyperLink>
 ...
 | <asp:HyperLink ID="HyperLink4" runat="server" NavigateUrl="http://www.hub-eshop.com/" Target="_blank">Hub Eshop</asp:HyperLink> 
 | <asp:HyperLink ID="HyperLink5" runat="server" NavigateUrl="http://www.gentxt.com.ph/" Target="_blank">GenTxt</asp:HyperLink> 
 | <asp:HyperLink ID="HyperLink6" runat="server" NavigateUrl="http://www.globesolutions.com.ph/" Target="_blank">Globe Solutions</asp:HyperLink> 
