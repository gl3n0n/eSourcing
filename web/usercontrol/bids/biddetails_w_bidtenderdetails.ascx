<%@ control language="C#" autoeventwireup="true" inherits="web_usercontrol_bids_biddetails_w_bidtenderdetails, App_Web_biddetails_w_bidtenderdetails.ascx.712a9dd6" %>
<div align="left">
