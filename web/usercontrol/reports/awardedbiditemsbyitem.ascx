<%@ control language="C#" autoeventwireup="true" inherits="web_usercontrol_reports_awardedbiditemsbyitem, App_Web_awardedbiditemsbyitem.ascx.d6e4e657" %>
...
<table border="0" cellpadding="0" cellspacing="0" style="font-size: 11px; font-family: Arial; width: 100%">
    <tr>
        <td valign="top" style="padding-top: 5px;">
            Item(s)</td>
        <td>
            <asp:ListBox ID="lbItems" runat="server" SelectionMode="Multiple" Width="300px" DataSourceID="sdsItems" DataTextField="Item" DataValueField="SKU" Rows="6"></asp:ListBox><asp:SqlDataSource ID="sdsItems"
                runat="server" ConnectionString="<%$ ConnectionStrings:EBidConnectionString %>" SelectCommand="sp_GetProducts" SelectCommandType="StoredProcedure"></asp:SqlDataSource>
        </td>
    </tr>
    <tr>
        <td valign="top" style="padding-top: 5px;">
