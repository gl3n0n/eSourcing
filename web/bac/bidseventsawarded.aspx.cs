...
{
    public partial class bidseventsawarded : System.Web.UI.Page
    {
        ...
        protected void gvBidEventsAwarded_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            else if (e.CommandName.Equals("bidEvent"))
            {
                ...
                Response.Redirect("bidawardingchecklistview.aspx");
            }
        }
        ...
        protected void gvBidEventsAwarded_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                
                string key1 = gvBidEventsAwarded.DataKeys[e.Row.RowIndex].Values[0].ToString();
                string key2 = gvBidEventsAwarded.DataKeys[e.Row.RowIndex].Values[1].ToString();
                string key3 = gvBidEventsAwarded.DataKeys[e.Row.RowIndex].Values[2].ToString();
                string key4 = gvBidEventsAwarded.DataKeys[e.Row.RowIndex].Values[3].ToString();
                string key5 = gvBidEventsAwarded.DataKeys[e.Row.RowIndex].Values[4].ToString();
                string key6 = gvBidEventsAwarded.DataKeys[e.Row.RowIndex].Values[5].ToString();
               
            }
            if (e.Row.RowType == DataControlRowType.Footer)
            {
                if (gvBidEventsAwarded.DataKeys.Count > 0)
                {
                    // Use the GetEnumerator method to create an enumerator that 
                    // contains the DataKey objects for the GridView control.
                    //IEnumerator keyEnumerator = gvBidEventsAwarded.DataKeys.GetEnumerator();
                    ...
                    while (keyEnumerator.MoveNext())
                    {
                        ...
                        Panel pnl1 = (Panel)gvBidEventsAwarded.Rows[i].Cells[3].Controls[1];
                        Panel pnl2 = (Panel)gvBidEventsAwarded.Rows[i].Cells[3].Controls[3];
                        LinkButton lb = (LinkButton)gvBidEventsAwarded.Rows[i].Cells[3].Controls[3].Controls[1];
