<%@ Page Language="c#" EnableEventValidation="true" Inherits="EBid.WEB.bac.bidseventsforawarding" CodeFile="bidseventsforawarding.aspx.cs" %>
                                                ...
                                                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                    <tr>
                                                        <td id="content0">
                                                            <h1>
                                                                <br />
                                                                Bid Events For Awarding</h1>
                                                            <br />
                                                            <asp:GridView runat="server" ID="gvBidEventsForAwarding" SkinID="BidEvents" AllowPaging="True"
                                                                ...
                                                                OnRowCommand="gvBidEventsForAwarding_RowCommand" OnRowDataBound="gvBidEventsForAwarding_RowDataBound">
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="Date Endorsed" SortExpression="Deadline">
                                                                        <HeaderStyle HorizontalAlign="Center" />
