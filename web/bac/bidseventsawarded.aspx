<%@ Page Language="c#" EnableEventValidation="true" Inherits="EBid.WEB.bac.bidseventsawarded" CodeFile="bidseventsawarded.aspx.cs" %>
                                                ...
                                                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                    <tr>
                                                        <td id="content0">
                                                            <h1>
                                                                <br />
                                                                Bid Events Awarded</h1>
                                                            <br />
                                                            <asp:GridView runat="server" ID="gvBidEventsAwarded" SkinID="BidEvents" AllowPaging="True"
                                                                ...
                                                                OnRowCommand="gvBidEventsAwarded_RowCommand" OnRowDataBound="gvBidEventsAwarded_RowDataBound">
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="Date Awarded" SortExpression="Deadline">
                                                                        <HeaderStyle HorizontalAlign="Center" />
