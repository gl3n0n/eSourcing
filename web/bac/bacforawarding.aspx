<%@ Page Language="C#" AutoEventWireup="true" CodeFile="bacforawarding.aspx.cs" Inherits="web_bac_bacforawarding" %>
<%@ Register TagPrefix="EBid" TagName="TopDate" Src="~/WEB/usercontrol/TopDate.ascx" %>
<%@ Register TagPrefix="EBid" TagName="GlobalLinksNav" Src="~/web/usercontrol/GlobalLinksNav.ascx" %>
<%@ Register TagPrefix="EBid" TagName="Purchasing_TopNav_Bids" Src="~/web/usercontrol/Bac/BAC_TopNav_Bids.ascx" %>
<%@ Register TagPrefix="EBid" TagName="Purchasing_LeftNav" Src="~/web/usercontrol/Bac/BAC_LeftNav_Bids.ascx" %>
                                                ...
                                                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                    <tr>
                                                        <td id="content0">
                                                            <h1>
                                                                <br />
                                                                Ongoing Bid Awarding Checklist</h1>
                                                            <br />
                                                    ...
                                                    <%--<asp:SqlDataSource ID="dsAproved" runat="server" ConnectionString="<%$ ConnectionStrings:EBidConnectionString %>" 
                                                        SelectCommand="select * from vwBACForApproval where approvedBy=@UserId ORDER BY PreparedDt DESC"  SelectCommandType="Text" >
                                                        <SelectParameters>
                                                    ...
                                                    <asp:SqlDataSource ID="dsAproved" runat="server" ConnectionString="<%$ ConnectionStrings:EBidConnectionString %>"
                                                        SelectCommand="SELECT t1.*, CONVERT(VARCHAR, t1.BidRefNo)+';'+CONVERT(VARCHAR, t1.BacRefNo)+';'+CONVERT(VARCHAR, t1.BuyerId) AS BACBID,
                                                                       ...
                                                                       WHERE (v1.bacid=@BuyerId OR v2.bacid=@BuyerId OR v3.bacid=@BuyerId OR v4.bacid=@BuyerId OR v5.bacid=@BuyerId OR v6.bacid=@BuyerId OR v7.bacid=@BuyerId OR v8.bacid=@BuyerId OR v9.bacid=@BuyerId OR v10.bacid=@BuyerId) AND Status between 1 and 2
                                                                       ORDER BY DateSubmitted DESC"  SelectCommandType="Text">
                                                        <SelectParameters>
