<%@ Page Language="C#" AutoEventWireup="true" CodeFile="bacrejected.aspx.cs" Inherits="web_bac_bacrejected" %>
                                            ...
                                            <td valign="top">
                                                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                    <tr>
                                                        ...
                                                        SelectCommand="select * from vwBACRejected where approvedBy=@BacId ORDER BY PreparedDt DESC" 
                                                        SelectCommandType="Text">
                                                        <SelectParameters>
                                                            <asp:SessionParameter Name="BacId" SessionField="UserId" Type="Int32" />
