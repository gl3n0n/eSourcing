...
{	
	...
	public static class RandomPasswordGenerator
	{
        ...
        public static string GenerateRandomPassword(int minLength, int maxLength, bool includeSymbols)
        {
            PasswordGenerator pwdgen = new PasswordGenerator();
            pwdgen.IncludeSymbols = includeSymbols;
            pwdgen.Minimum = minLength;
            pwdgen.Maximum = maxLength;
            pwdgen.ConsecutiveCharacters = false;
            pwdgen.RepeatCharacters = true;
            return pwdgen.GenerateRandomPassword();
        }
